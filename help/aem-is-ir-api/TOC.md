...
user-guide-title: API Diffusion et Rendu dʼimages Dynamic Media
breadcrumb-title: API Diffusion et Rendu dʼimages Dynamic Media
feature-set: Experience Manager Assets
user-guide-description: Consultez la documentation sur les API Diffusion dʼimages (IS) et Rendu dʼimages (IR) ainsi que sur les technologies associées.
...
# API Diffusion et Rendu dʼimages Dynamic Media {#image-serving-api}

+ [Page d’accueil de l’API de diffusion d’images et de rendu d’images de Dynamic Media](homeisir.md)<!-- (https://experienceleague.adobe.com/docs/dynamic-media-developer-resources/image-serving-api/homeisir.html) -->
...
+ API de diffusion d’images {#image-serving-api}
   ...
   + Référence du protocole HTTP {#http-protocol-reference}
      ...
      + Syntaxe et fonctionnalités {#syntax-and-features}
         ...
         + Image Serving, commande de protocole HTTP {#image-serving-http}
            ...
            + [Commandes des effets de calque](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/c-command-overview/r-layer-effect-commands-and-attributes.md)
         ...
         + [Prise en charge SVG](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/r-svg-support.md)
      ...
      + Référence de commande {#command-reference}
         ...
         + [effetMask](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-effectmask.md)
      ...
      + Comportement du serveur {#server-behavior}
         ...
         + [La zone de travail du compositeur](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-notes-on-server-behavior/r-the-compositing-canvas.md)
   ...
   + Référence des données d’image/SVG {#image-svg-ref}
      + [Référence des données d’image/SVG](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-image-svg-data-reference/c-image-svg-data-reference.md)
   ...
   + Référence de jeu de règles {#rule-set-reference}
   ...
   + Bibliothèque d’images statiques réactives {#responsive-static-image-library}
...
+ API de rendu d’image {#image-rendering-api}
   ...
   + Configuration {#configuration}
      ...
      + [Installation et configuration du module de compatibilité IR 3.x](ir-api/image-rendering-api-ref/c-ir-installation/t-ir-setup-compatibility-module.md)
   ...
   + Référence du protocole HTTP {#http-protocol-reference}
      ...
      + Référence de commande de protocole HTTP {#http-protocol-command-reference}
         ...
         + [gèle](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-http-gloss.md)
   ...
   + Catalogue de matières {#material-catalog}
      ...
      + Référence des données matérielles {#material-data-reference}
         ...
         + [Grain](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-material-data-reference/r-ir-cat-gloss.md)
      ...
      + Référence de mappage de profil ICC {#icc-profile-map-reference}
         + [Référence de mappage de profil ICC](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-icc-profile-map-reference/c-ir-icc-profile-map-reference.md)
      ...
      + Référence de jeu de règles {#rule-set-reference}
         + [Référence d’ensemble de règles](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-rule-set-reference/c-ir-rule-set-reference.md)
         + [address filter](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-rule-set-reference/r-ir-addressfilter.md)
...
+ Utilitaires {#utilites}
   ...
   + Convertisseur de vignettes (vntc){#vignette-converter-vntc}
      ...
      + [Mise à l’échelle des vignettes](ir-api/vntc/utilities/c-ir-vignette-converter-vntc/c-ir-vignette-scaling.md)
      ...
      + [Options des fichiers de style Cabinet](ir-api/vntc/utilities/c-ir-vignette-converter-vntc/r-ir-options-for-cabinet-style-files.md)
