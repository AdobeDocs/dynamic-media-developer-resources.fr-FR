...
+ [Conventions de document](r-document-conventions.md)
+ Installation {#install}
   ...
   + Installation sous Windows {#windows-install}
      ...
      + [Mise à jour à partir d’IS 4.7.4 ou version ultérieure](c-installation/t-installing-on-windows/t-update-win.md)
   ...
   + Installation sous Linux {#linux-install}
      ...
      + [Mise à jour à partir d’IS 4.7.4 ou version ultérieure](c-installation/c-installing-linux/t-update-lin.md)
...
+ API du service d’images {#image-serving-api}
   + [API du service d’images](is-api/image-serving-api-ref/c-is-home.md)
   ...
   + Configuration et administration {#config-admin}
      ...
      + Caches de données {#data-caches}
         ...
         + [Cache des données de réponse](is-api/image-serving-api-ref/c-configuration-and-administration/c-data-caches/c-response-data-cache.md)
         ...
         + [Mise en cluster du cache](is-api/image-serving-api-ref/c-configuration-and-administration/c-data-caches/c-cache-clustering.md)
      + Paramètres du serveur {#server-settings}
         ...
         + [Caches du serveur](is-api/image-serving-api-ref/c-configuration-and-administration/c-server-settings/r-server-caches.md)
         + [Limites de taille des images](is-api/image-serving-api-ref/c-configuration-and-administration/c-server-settings/r-image-size-limits.md)
         ...
         + [Journalisation de Debug_trace](is-api/image-serving-api-ref/c-configuration-and-administration/c-server-settings/r-debug-trace-logging.md)
         ...
         + [Mise en cluster du cache](is-api/image-serving-api-ref/c-configuration-and-administration/c-server-settings/r-cache-clustering.md)
         ...
         + [Réponses des visionneuses de médias](is-api/image-serving-api-ref/c-configuration-and-administration/c-server-settings/r-media-set-responses.md)
      + [Rediriger en cas d’erreur](is-api/image-serving-api-ref/c-configuration-and-administration/c-redirect-on-error.md)
      ...
      + [Définir des chiffrements SSL](is-api/image-serving-api-ref/c-configuration-and-administration/r-ssl-ciphers.md)
      ...
      + Journalisation du serveur {#server-logging}
         ...
         + [Log de trace](is-api/image-serving-api-ref/c-configuration-and-administration/c-server-logging/c-trace-log.md)
      ...
      + Gestion du contenu {#manage-content}
         ...
         + [Supprimer ou remplacer des fichiers de données](is-api/image-serving-api-ref/c-configuration-and-administration/c-managing-content/c-deleting-or-replacing-data-files.md)
   + [Diffusion de contenu statique (hors images)](is-api/image-serving-api-ref/c-serving-static-nonimage-contents.md)
   ...
   + Référence du protocole HTTP {#http-protocol-reference}
      + [Présentation de la référence du protocole HTTP](is-api/image-serving-api-ref/c-http-protocol-reference/c-http-protocol-reference.md)
      + Présentation du protocole HTTP {#http-protocol-introduction}
         ...
         + [Conventions de document](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-introduction/r-document-conventions.md)
      + Syntaxe et fonctionnalités {#syntax-and-features}
         ...
         + [Syntaxe de base du protocole HTTP du service d’images](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/r-basic-syntax.md)
         + Commande de protocole HTTP du service d’images {#image-serving-http}
            + [Présentation de la commande de protocole HTTP de diffusion d’images](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/c-command-overview/c-command-overview.md)
            ...
            + [Opérations sur les images Source](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/c-command-overview/r-source-image-operations-and-attributes.md)
            + [Commandes de calque courantes](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/c-command-overview/r-common-layer-commands-and-attributes.md)
            + [Commandes de calque d’image](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/c-command-overview/r-image-layer-commands-and-attributes.md)
         ...
         + Superposition {#layering}
            + [Présentation de la superposition](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/c-layering-overview/c-layering-overview.md)
            ...
            + [Zone de travail de composition](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/c-layering-overview/c-compositing-canvas.md)
         ...
         + [Demander l’imbrication et l’incorporation](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/r-request-nesting-and-embedding.md)
         ...
         + [Gestion des couleurs du service d’images](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/r-color-management.md)
         + [Encodage HTTP de la diffusion d’images](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/r-http-encoding.md)
         + [Verrouillage de requête](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/r-request-locking.md)
         + [Obfuscation de requête](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/r-request-obfuscation.md)
         + [Filigranes](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/r-watermarks.md)
         + [Diffusion de contenu statique (hors images)](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/r-serving-static-non-image-content.md)
      ...
      + Formatage du texte {#text-formatting}
         + [Présentation de la mise en forme du texte](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-text-formatting/c-text-formatting.md)
         ...
         + [Ajustement par copie](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-text-formatting/r-copy-fitting.md)
         ...
         + Prise en charge de RTF {#rtf-support}
            ...
            + [Propriétés du document (zone de texte)](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-text-formatting/c-supported-rtf-commands-and-keywords/r-document-text-box-properties.md)
            ...
            + [Formatage de base des caractères](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-text-formatting/c-supported-rtf-commands-and-keywords/r-basic-character-formatting.md)
      ...
      + Référence des commandes {#command-reference}
         ...
         + [brownMode](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-blendmode.md)
         ...
         + [cropsPathE](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-croppath.md)
         ...
         + [adapter](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-fit.md)
         ...
         + [établissement d&#39;enseignement supérieur](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-is-http-hei.md)
         + [masquer](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-hide.md)
         + [cpi](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-icc.md)
         ...
         + req {#req}
            + [vue d’ensemble req](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-req/r-req.md)
            ...
            + [visionneuse d’images](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-req/r-imageset-req.md)
            ...
            + [œillet](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-req/r-tmb.md)
            ...
            + [ardoise](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-req/r-xlate.md)
         ...
         + [mettre à l&#39;échelle](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-is-http-scale.md)
         ...
         + [éolien](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-is-http-wid.md)
      ...
      + Données de réponse {#response-data}
         ...
         + Propriétés {#properties}
            ...
            + [Propriétés de JavaScript](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-response-data/c-properties/r-javascript-properties.md)
      ...
      + Comportement du serveur {#server-behavior}
         ...
         + [Zone de travail de composition](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-notes-on-server-behavior/r-the-compositing-canvas.md)
         + [Transformations de calque](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-notes-on-server-behavior/r-layer-transforms.md)
         ...
         + [Placement des calques](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-notes-on-server-behavior/r-layer-placement.md)
         + [Transformation de la vue pour les images](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-notes-on-server-behavior/r-view-transform-for-images.md)
         + [Transformation des vues pour les miniatures](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-notes-on-server-behavior/r-view-transform-for-thumbnails.md)
      + Modèles {#templates}
   ...
   + Référence du protocole du serveur FXG {#fxg-server-protocol-ref}
      ...
      + Protocole du serveur FXG {#fxg-server-protocol}
         ...
         + Référence du protocole du serveur FXG {#protocol-ref}
            + [Présentation de la référence du protocole du serveur FXG](is-api/fxg-server-protocol/image-serving-api-ref/c-is-fxg-server-protocol/c-fxg-server-protocol-reference/c-fxg-server-protocol-reference.md)
            + [marge de fond perdu](is-api/fxg-server-protocol/image-serving-api-ref/c-is-fxg-server-protocol/c-fxg-server-protocol-reference/r-bleedmargin.md)
            ...
            + [établissement d&#39;enseignement supérieur](is-api/fxg-server-protocol/image-serving-api-ref/c-is-fxg-server-protocol/c-fxg-server-protocol-reference/r-is-fxg-hei.md)
            ...
            + [mettre à l&#39;échelle](is-api/fxg-server-protocol/image-serving-api-ref/c-is-fxg-server-protocol/c-fxg-server-protocol-reference/r-is-fxg-scale.md)
            ...
            + [éolien](is-api/fxg-server-protocol/image-serving-api-ref/c-is-fxg-server-protocol/c-fxg-server-protocol-reference/r-is-fxg-wid.md)
         ...
         + Commandes de traitement par lots {#batch-process-commands}
            ...
            + [batchjobbrief status](is-api/fxg-server-protocol/image-serving-api-ref/c-is-fxg-server-protocol/c-batch-processing-commands/r-batchjobbriefstatus.md)
   ...
   + Référence de catalogue d’images {#image-catalog-reference}
      + [Référence de catalogue d’images](is-api/image-serving-api-ref/c-image-catalog-reference/c-image-catalog-reference.md)
      ...
      + Attributs de catalogue {#catalog-attributes}
         ...
         + [Valeurs par défaut des champs du catalogue](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-overview/c-catalog-attributes/r-defaults-for-catalog-fields.md)
      ...
      + Formats de fichier {#file-formats}
         ...
         + [Fichiers d’attributs de catalogue](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-overview/c-file-formats/r-catalog-attribute-files.md)
         + [Fichiers de données du catalogue](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-overview/c-file-formats/r-catalog-data-files.md)
         + [Fichiers d’ensemble de règles](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-overview/c-file-formats/r-rule-set-files.md)
      ...
      + Types de données courants {#common-data-types}
         ...
         + [Drapeau](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-overview/c-common-data-types/r-flag.md)
         + [Énumération](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-overview/c-common-data-types/r-enum.md)
         ...
         + [Chaîne texte](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-overview/c-common-data-types/r-text-string.md)
   ...
   + Attributs {#attributes}
      ...
      + [Expiration par défaut](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-attributes-reference/r-defaultexpiration.md)
   ...
   + Référence des données Image/SVG {#image-svg-ref}
      + [Référence des données Image/SVG](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-image-svg-data-reference/c-image-svg-data-reference.md)
      + Référence des données d’image {#image-data-reference}
         ...
         + [Type de ressource](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-image-svg-data-reference/c-image-data-reference/r-assettype-cat.md)
      ...
      + Référence des données SVG {#svg-data-reference}
         + [Référence des données SVG](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-image-svg-data-reference/c-svg-data-reference/c-svg-data-reference.md)
      ...
      + Données de contenu statiques {#static-content-data}
   ...
   + Définition d&#39;une macro {#macro-definition}
   ...
   + Référence de la carte de profil ICC {#icc-profile-map-reference}
      + [Référence de la carte de profil ICC](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-icc-profile-map-reference/c-icc-profile-map-reference.md)
   ...
   + Bibliothèque d’images statique réactive {#responsive-static-image-library}
      ...
      + [Référence des commandes - Attributs de configuration](is-api/image-serving-api-ref/c-about-responsive-static-image-library/r-responsive-static-image-library-config-attrib.md)
+ API de rendu d’image {#image-rendering-api}
   ...
   + Configuration {#configuration}
      ...
      + [Octroi de licence](ir-api/image-rendering-api-ref/c-ir-installation/c-ir-licensing.md)
      + [Configuration du module de compatibilité IR 3.x](ir-api/image-rendering-api-ref/c-ir-installation/t-ir-setup-compatibility-module.md)
      + [Installation et configuration du rendu d’image](ir-api/image-rendering-api-ref/c-ir-installation/c-ir-setup-ir.md)
   ...
   + Administration du serveur {#server-administration}
      ...
      + Configuration et gestion du serveur {#configuring-and-managing-the-server}
         + [Configuration et gestion de la vue d’ensemble du serveur](ir-api/server-admin/image-rendering-api-ref/c-ir-server-administration/c-ir-configuring-and-managing-the-server/c-ir-configuring-and-managing-the-server.md)
         ...
         + [Limitation de la taille de la vignette](ir-api/server-admin/image-rendering-api-ref/c-ir-server-administration/c-ir-configuring-and-managing-the-server/c-ir-vignette-size-limitation.md)
      ...
      + Référence des paramètres de configuration {#configuration-settings-reference}
         ...
         + [Dossier du cache du catalogue (ir.catalogCacheRoot)](ir-api/server-admin/image-rendering-api-ref/c-ir-server-administration/c-ir-configuration-settings-reference/c-ir-catalog-cache-folder.md)
         + [Dossiers racine des ressources (ir.resourceRootPaths)](ir-api/server-admin/image-rendering-api-ref/c-ir-server-administration/c-ir-configuration-settings-reference/c-ir-resource-root-folders.md)
   + Référence du protocole HTTP {#http-protocol-reference}
      ...
      + Syntaxe et fonctionnalités du protocole HTTP {#http-protocol-syntax}
         + [Syntaxe et fonctionnalités du protocole HTTP](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-http-protocol-syntax-and-features.md)
         ...
         + Présentation de la commande de protocole HTTP de rendu d’image {#image-rendering-http-protocol-command-overview}
            ...
            + [Afficher les attributs](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-command-overview/r-ir-view-attributes.md)
         ...
         + Vignettes {#vignettes}
            ...
            + [Coordonnées de la scène](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-vignettes/c-ir-scene-coordinates.md)
            + [Résolution matérielle](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-vignettes/c-ir-material-resolution.md)
         + Matériaux {#materials}
            ...
            + [Décorations](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-http-materials/r-ir-decals.md)
         ...
         + Effets de rendu avancés {#advanced-render-effects}
            ...
            + [Utilisation de plusieurs textures d&#39;illumination](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-advanced-render-effects/c-ir-use-multiple-illumination-maps.md)
            + [Matériaux colorants](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-advanced-render-effects/c-ir-colorizing-materials.md)
            + [Opacité de matériau variable](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-advanced-render-effects/c-ir-varying-material-opacity.md)
         ...
         + Demander l’imbrication et l’incorporation {#request-nesting-and-embedding}
            ...
            + [Requêtes du serveur d’images intégré](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-request-nesting-and-embedding/c-ir-embedded-image-serving-requests.md)
            + [Requêtes de rendu d’image imbriquées](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-request-nesting-and-embedding/c-ir-nested-image-rendering-requests.md)
         ...
         + [Pré-traitement des demandes *](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-request-pre-processing.md)
         + Variables personnalisées {#custom-variables}
            ...
            + [Traitement des variables dans des requêtes étrangères incorporées](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-custom-variables/c-ir-variable-processing-in-embedded-foreign-requests.md)
         ...
         + [Gestion des couleurs du rendu des images *](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-color-management.md)
      ...
      + Référence des commandes de protocole HTTP {#http-protocol-command-reference}
         + [Référence des commandes de protocole HTTP](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/c-ir-http-protocol-command-reference.md)
         ...
         + [vignette](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-decal.md)
         ...
         + [briller](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-http-gloss.md)
         + [carte lexicale](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-glossmap.md)
         + [coulis](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-grout.md)
         + [établissement d&#39;enseignement supérieur](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-hei.md)
         ...
         + [cpi](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-icc.md)
         ...
         + [rude](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-rough.md)
         ...
         + [vif](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-http-sharp.md)
         + [aiguiser](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-http-sharpen.md)
         ...
         + [sous-marin](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-sub.md)
         ...
         + [éolien](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-wid.md)
   ...
   + Catalogue de matériaux {#material-catalog}
      + [Catalogue de matériaux](ir-api/image-rendering-api-ref/c-ir-material-catalog/c-ir-material-catalog.md)
      ...
      + Présentation du catalogue de matières {#material-catalog-overview}
         + [Présentation du catalogue de matériaux *](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-cat-overview/c-ir-cat-overview.md)
         ...
         + Formats de fichier {#file-formats}
            ...
            + [Fichiers d’attributs de catalogue](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-cat-overview/c-ir-file-formats/c-ir-catalog-attribute-files.md)
            + [Fichiers de données du catalogue](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-cat-overview/c-ir-file-formats/c-ir-catalog-data-files.md)
      ...
      + Référence des attributs {#attributes-reference}
         ...
         + [Chemin racine *](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-attributes-reference/r-ir-rootpath.md)
      ...
      + Référence des données matérielles {#material-data-reference}
         + [Référence des données matérielles](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-material-data-reference/c-ir-material-data-reference.md)
         ...
         + [Briller](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-material-data-reference/r-ir-cat-gloss.md)
         ...
         + [Répéter](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-material-data-reference/r-ir-cat-repeat.md)
         ...
         + [Rugosité](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-material-data-reference/r-ir-roughness.md)
      ...
      + Référence de carte de Vignette {#vignette-map-reference}
         + [Référence de carte de Vignette](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-vignette-map-reference/c-ir-vignette-map-reference.md)
      ...
      + Référence de la carte de profil ICC {#icc-profile-map-reference}
         + [Référence de la carte de profil ICC](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-icc-profile-map-reference/c-ir-icc-profile-map-reference.md)
...
+ Utilitaires {#utilites}
   ...
   + Utilitaires de diffusion d’images {#image-serving-utilities}
      ...
      + [Emplacement des services publics](is-api/is-utils/utilities/c-location-of-utilities.md)
      + [ic](is-api/is-utils/utilities/r-ic.md)
      + [Diffusion d’images](is-api/is-utils/utilities/r-imageserving.md)
   ...
   + Convertisseur de vignette (vntc){#vignette-converter-vntc}
      + [Convertisseur de vignette (vntc)](utilities/c-ir-vignette-converter-vntc/c-ir-vignette-converter-vntc.md)
      + [Convertisseur De Vignette](ir-api/vntc/utilities/c-ir-vignette-converter-vntc/c-ir-vignette-converter.md)
      + [Dimensionnement de la vignette](ir-api/vntc/utilities/c-ir-vignette-converter-vntc/c-ir-vignette-scaling.md)
      + [Utilisation](ir-api/vntc/utilities/c-ir-vignette-converter-vntc/r-ir-usage.md)
      + [Options courantes](ir-api/vntc/utilities/c-ir-vignette-converter-vntc/r-ir-common-options.md)
      + [Options des vignettes](ir-api/vntc/utilities/c-ir-vignette-converter-vntc/r-ir-options-for-vignettes.md)
