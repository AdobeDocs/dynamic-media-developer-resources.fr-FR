...
+ [Accueil de l’API de diffusion d’images et de rendu d’images de Contenu multimédia dynamique](home.md)
...
+ [Configuration requise et recommandations relatives à l’espace disque](r-disk-space-reqs.md)
+ [Restrictions et problèmes connus](r-restrictions-and-known-issues.md)
+ [Assistance technique](r-tech-support.md)
+ [Conventions de](r-document-conventions.md)
+ Installation {#install}
   ...
   + Installation sous Windows {#windows-install}
      ...
      + [Installation sous un compte utilisateur différent de celui d’administrateur](c-installation/t-installing-on-windows/t-diff-account-win.md)
...
+ API de diffusion d’images {#image-serving-api}
   ...
   + [prévu](is-api/image-serving-api-ref/c-intended-audience.md)
   ...
   + Configuration et administration {#config-admin}
      ...
      + Paramètres du serveur {#server-settings}
         ...
         + [Journalisation d’accès](is-api/image-serving-api-ref/c-configuration-and-administration/c-server-settings/r-access-logging.md)
         ...
         + [Réponses de la visionneuse de supports](is-api/image-serving-api-ref/c-configuration-and-administration/c-server-settings/r-media-set-responses.md)
      ...
      + [Définition des chiffrement SSL](is-api/image-serving-api-ref/c-configuration-and-administration/r-ssl-ciphers.md)
   ...
   + Référence au protocole HTTP {#http-protocol-reference}
      ...
      + Présentation du protocole HTTP {#http-protocol-introduction}
         ...
         + [prévu](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-introduction/c-intended-audience.md)
         + [Conventions de](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-introduction/r-document-conventions.md)
      + Syntaxe et fonctionnalités {#syntax-and-features}
         ...
         + Image Serving HTTP, commande de protocole {#image-serving-http}
            + [Présentation du protocole HTTP Image Serving, commande](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/c-command-overview/c-command-overview.md)
            ...
            + [Commandes de](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/c-command-overview/r-view-commands-and-attributes.md)
            ...
            + [Commandes d’effet Calque](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/c-command-overview/r-layer-effect-commands-and-attributes.md)
         + Superposition {#layering}
            + [Présentation des calques](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/c-layering-overview/c-layering-overview.md)
            ...
            + [La toile de composition](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/c-layering-overview/c-compositing-canvas.md)
         ...
         + [Imbrication et incorporation des requêtes](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/r-request-nesting-and-embedding.md)
         ...
         + [Traduction d’ID d’objet](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/r-object-id-translation.md)
         + [de chaîne de texte](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/r-text-string-localization.md)
         ...
         + [Mappages d’images](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/r-image-maps.md)
         ...
         + [Codage HTTP Image Serving](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/r-http-encoding.md)
      ...
      + Formatage du texte {#text-formatting}
         ...
         + [Copier-ajuster](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-text-formatting/r-copy-fitting.md)
         ...
         + Prise en charge RTF {#rtf-support}
            ...
            + [Propriétés de la  (zone de texte)](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-text-formatting/c-supported-rtf-commands-and-keywords/r-document-text-box-properties.md)
            ...
            + [Formatage de caractères de base](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-text-formatting/c-supported-rtf-commands-and-keywords/r-basic-character-formatting.md)
            ...
            + [Entités textuelles spéciales](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-text-formatting/c-supported-rtf-commands-and-keywords/r-special-text-entities.md)
      ...
      + Référence de commande {#command-reference}
         ...
         + [masquer](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-mask.md)
         ...
         + req {#req}
            ...
            + [masquer](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-req/r-mask-req.md)
      ...
      + Comportement du serveur {#server-behavior}
         ...
         + [La toile de composition](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-notes-on-server-behavior/r-the-compositing-canvas.md)
         ...
         + [Positionnement des calques](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-notes-on-server-behavior/r-layer-placement.md)
         + [de transformation pour les images](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-notes-on-server-behavior/r-view-transform-for-images.md)
         + [de transformation pour les miniatures](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-notes-on-server-behavior/r-view-transform-for-thumbnails.md)
      + Modèles {#templates}
   ...
   + Référence du protocole du serveur FXG {#fxg-server-protocol-ref}
      ...
      + Protocole serveur FXG {#fxg-server-protocol}
         + [Protocole serveur FXG](is-api/fxg-server-protocol/image-serving-api-ref/c-is-fxg-server-protocol/c-fxg-server-protocol.md)
         + Référence du protocole du serveur FXG {#protocol-ref}
            + [Présentation du protocole FXG Server](is-api/fxg-server-protocol/image-serving-api-ref/c-is-fxg-server-protocol/c-fxg-server-protocol-reference/c-fxg-server-protocol-reference.md)
   ...
   + Référence du catalogue d’images {#image-catalog-reference}
      ...
      + Champs de données du catalogue {#catalog-data-fields}
         ...
         + [de ICC](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-overview/c-catalog-data-fields/r-icc-profile-maps.md)
      + Formats de fichier {#file-formats}
         ...
         + [Fichiers d’attribut de catalogue](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-overview/c-file-formats/r-catalog-attribute-files.md)
         ...
         + [Fichiers du jeu de règles](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-overview/c-file-formats/r-rule-set-files.md)
   ...
   + Attributes {#attributes}
      ...
      + [CouleurBkgPouce](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-attributes-reference/r-thumbbkgcolor.md)
   ...
   + Mappage de polices {#font-map}
      + [Référence du mappage de polices](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-font-map-reference/c-font-map-reference.md)
   ...
   + Référence du mappage de  ICC {#icc-profile-map-reference}
      + [Référence du mappage de  ICC](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-icc-profile-map-reference/c-icc-profile-map-reference.md)
   ...
   + [Proxy du serveur d’images](is-api/image-serving-api-ref/r-image-server-proxy.md)
   + [Exemples de serveur d’images](is-api/image-serving-api-ref/r-examples-is.md)
   + Bibliothèque d’images statique réactive {#responsive-static-image-library}
      + [Bibliothèque d’images statiques réactives](is-api/image-serving-api-ref/c-about-responsive-static-image-library/c-about-responsive-static-image-library.md)
...
+ API de rendu d’image {#image-rendering-api}
   ...
   + Administration du serveur {#server-administration}
      ...
      + Configuration et gestion du serveur {#configuring-and-managing-the-server}
         ...
         + [Remarques concernant la mémoire](ir-api/server-admin/image-rendering-api-ref/c-ir-server-administration/c-ir-configuring-and-managing-the-server/c-ir-memory-considerations.md)
         ...
         + [Limite de taille du vignette](ir-api/server-admin/image-rendering-api-ref/c-ir-server-administration/c-ir-configuring-and-managing-the-server/c-ir-vignette-size-limitation.md)
      ...
      + Référence des paramètres de configuration {#configuration-settings-reference}
         + [Présentation des références des paramètres de configuration](ir-api/server-admin/image-rendering-api-ref/c-ir-server-administration/c-ir-configuration-settings-reference/c-ir-configuration-settings-reference.md)
   ...
   + Référence au protocole HTTP {#http-protocol-reference}
      + [Référence au protocole HTTP](ir-api/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-ref.md)
      ...
      + Syntaxe du protocole HTTP et fonctionnalités {#http-protocol-syntax}
         ...
         + Présentation de la commande du protocole HTTP de rendu d’image {#image-rendering-http-protocol-command-overview}
            + [Présentation de la commande du protocole HTTP de rendu d’image](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-command-overview/c-ir-command-overview.md)
            + [Attributs de](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-command-overview/r-ir-view-attributes.md)
         ...
         + Matériaux {#materials}
            ...
            + [Recouvrements de fenêtre](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-http-materials/r-ir-window-coverings.md)
         + Effets de rendu avancés {#advanced-render-effects}
            ...
            + [Opacité du matériau variable](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-advanced-render-effects/c-ir-varying-material-opacity.md)
            ...
            + [Effet brillant](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-advanced-render-effects/c-ir-gloss-effects.md)
            + [Paramètres de rendu avancé](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-advanced-render-effects/c-ir-advanced-render-settings.md)
         + Imbrication et incorporation des requêtes {#request-nesting-and-embedding}
            ...
            + [Requêtes Image Server intégrées](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-request-nesting-and-embedding/c-ir-embedded-image-serving-requests.md)
      ...
      + Référence de commande du protocole HTTP {#http-protocol-command-reference}
         ...
         + [grappin](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-grout.md)
         ...
         + [rugueux](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-rough.md)
         ...
         + [aigu](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-http-sharp.md)
   ...
   + Catalogue de matières {#material-catalog}
      ...
      + Présentation du catalogue de matières {#material-catalog-overview}
         ...
         + Formats de fichier {#file-formats}
            ...
            + [Fichiers d’attribut de catalogue](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-cat-overview/c-ir-file-formats/c-ir-catalog-attribute-files.md)
      ...
      + Référence de données de matériau {#material-data-reference}
         + [Référence de données de matériau](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-material-data-reference/c-ir-material-data-reference.md)
      ...
      + Référence de mappage de vignettes {#vignette-map-reference}
         + [Référence de mappage de vignettes](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-vignette-map-reference/c-ir-vignette-map-reference.md)
      ...
      + Référence du mappage de  ICC {#icc-profile-map-reference}
         + [Référence du mappage de  ICC](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-icc-profile-map-reference/c-ir-icc-profile-map-reference.md)
...
+ Utilitaires {#utilites}
   ...
   + Utilitaires de diffusion d’images {#image-serving-utilities}
      + [Utilitaires Image Serving](is-api/is-utils/utilities/c-utils-home.md)
