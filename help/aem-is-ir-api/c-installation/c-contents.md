...
description: Après l’installation, la hiérarchie de dossiers dans install_root comprend les fichiers et les dossiers répertoriés ci-dessous.
...
Après l’installation, la hiérarchie de dossiers dans install_root comprend les fichiers et les dossiers répertoriés ci-dessous.

>[!NOTE]
>
>Des fichiers et des dossiers supplémentaires sont présents ; ne les modifiez pas.
...
<table id="table_F9FE5E0622A54CCD88461078FD5EA3DC"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <span class="filepath"> des licences </span> </p> </td> 
   <td colname="col2"> </td> 
   <td colname="col3"> </td> 
   <td colname="col4"> <p>Dossier des fichiers de licence sous Linux®. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="filepath"> ImageServing/ </span> </p> </td> 
   <td colname="col2"> </td> 
   <td colname="col3"> </td> 
   <td colname="col4"> <p>Dossier racine d’installation du service d’images. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> <p> SAUVEGARDE/</span> <span class="filepath"> </p> </td> 
   <td colname="col3"> </td> 
   <td colname="col4"> <p>Sauvegardes de fichiers de configuration du service d’images des installations précédentes. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
  ...
  <tr> 
   ...
   <td colname="col4"> <p>Script de démarrage et d’arrêt de la diffusion d’images. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
  ...
  <tr> 
   ...
   <td colname="col4"> <p>Utilitaire de conversion d’images de diffusion d’images. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
   <td colname="col3"> <p> <span class="filepath"> PsLayers (.exe) </span> </p> </td> 
   <td colname="col4"> <p>[!DNL Photoshop] extraction des variables de calque de texte. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
   <td colname="col3"> <p> <span class="filepath"> valider (.exe) </span> </p> </td> 
   <td colname="col4"> <p>Utilitaire de validation d’image du service d’images. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
   <td colname="col3"> <p> <span class="filepath"> Vntc (.exe) </span> </p> </td> 
   <td colname="col4"> <p>Utilitaire de conversion de vignette, d'armoire et de couvre-fenêtre de rendu d'image. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
  ...
  <tr> 
   ...
   <td colname="col4"> <p>Le rendu d’image enregistre ici les données de catalogue compilées. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
   <td colname="col3"> <p> <span class="filepath">-response/ </span> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> </td> 
   <td colname="col4"> <p>Dossier de catalogues d’images IS configurable lors de l’installation ou en modifiant manuellement les fichiers de configuration. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
  ...
  <tr> 
   ...
   <td colname="col4"> <p> <span class="codeph">'</span> Default.ini est nécessaire pour que le serveur soit fonctionnel. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
  ...
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
   <td colname="col3"> <p> <span class="filepath"> catalog-service.conf </span> </p> <p> <span class="filepath"> ImageServerRegistry.xml </span> </p> <p> </span> <span class="filepath"> PlatformServer.conf </p> <p> <span class="filepath"> server.xml </span> </p> <p> <span class="filepath"> SupervisorRegistry.xml </span> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> <p> <span class="filepath"> des images/</span> </p> </td> 
   <td colname="col3"> </td> 
   <td colname="col4"> <p>Dossier de données source de la diffusion d’images ; modifiez manuellement les fichiers de configuration. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> <p> <span class="filepath"> journaux/</span> </p> </td> 
   <td colname="col3"> </td> 
   <td colname="col4"> <p>Toutes les données du journal PS et IS sont écrites dans ce dossier ; modifiez manuellement les fichiers de configuration. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> </td> 
   <td colname="col4"> <p>Dossier de la source de données à contenu statique ; modifiez manuellement les fichiers de configuration. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
  ...
  <tr> 
   ...
   <td colname="col4"> <p>Utilitaire de préchauffage du cache. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> <p> <span class="filepath"> webapps/ </span> </p> </td> 
   <td colname="col3"> </td> 
   <td colname="col4"> <p>Déployez les applications web Java™ ici (y compris is-docs, ir-docs et is-viewers). </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="filepath"> ImageRendering/ </span> </p> </td> 
   <td colname="col2"> </td> 
   <td colname="col3"> </td> 
   <td colname="col4"> <p>Dossier racine d’installation du rendu des images. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> <p> SAUVEGARDE/</span> <span class="filepath"> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <span class="filepath"> default-profiles/ </span> </p> </td> 
   <td colname="col3"> </td> 
   <td colname="col4"> <p>Contient les profils par défaut pour le rendu des images. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> <p> <span class="filepath"> ressources/</span> </p> </td> 
   <td colname="col3"> </td> 
   <td colname="col4"> <p>Dossier de données source du rendu des images ; modifiez manuellement les fichiers de configuration. </p> </td> 
  </tr> 
 </tbody> 
</table>
