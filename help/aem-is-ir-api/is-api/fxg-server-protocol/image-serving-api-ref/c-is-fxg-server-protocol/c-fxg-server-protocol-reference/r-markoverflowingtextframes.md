...
La définition du modificateur `markOverflowingTextFrames=1` par le biais d’un appel d’URL marque tous les blocs de texte dans lesquels le texte est en excès avec un signe plus. En outre, dans l’aperçu SPS, l’indicateur de texte en excès est défini sur &quot; `TRUE`&quot; par défaut.
