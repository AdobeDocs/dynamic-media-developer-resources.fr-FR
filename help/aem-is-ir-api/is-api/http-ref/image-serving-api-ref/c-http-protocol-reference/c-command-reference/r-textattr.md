...
<table id="simpletable_0072BF7DF52B4959A14EDEF60A6EBDEE"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Contrôle le mode anti-crénelage utilisé par le moteur de rendu de texte. </p> <p> <span class="codeph"> off | standard | crise | sharp | strong | lisse  </span> </p> <p> 
    <table id="simpletable_AE2331118FCA4BC7877233E287CED6A4"> 
     ...
     <tr class="strow"> 
      <td class="stentry"> <p> <span class="codeph"> crise  </span> </p> </td> 
      <td class="stentry"> <p>Sélectionnez le mode anti-alias Photoshop <span class="codeph"> crise </span> ( <span class="codeph"> textPs= </span> uniquement). </p> </td> 
     </tr> 
     <tr class="strow"> 
  ...
  <td class="stentry"> <p>Contrôle l’utilisation des termes lors du rendu du texte </p> <p> <span class="codeph"> fixedRes | autoRes | maxRes  </span> </p> <p> 
    <table id="simpletable_2CFC06DB37154C7C92614FDF7A818DB5"> 
     ...
     <tr class="strow"> 
      ...
      <td class="stentry"> <p>utiliser la résolution spécifiée ; réduisez-la si nécessaire afin d’empêcher la troncation du texte sur la recette du calque. </p> <p>Utilisez pour effectuer le rendu du texte à la résolution exacte spécifiée, tant qu’aucun détourage n’a lieu. En cas de détourage, la résolution est automatiquement réduite afin de garantir que tout le texte est contenu entièrement dans la zone de texte. Si le retour automatique à la ligne est activé, le texte peut être réencapsulé à la résolution finale. Non pris en charge par <span class="codeph"> textPs= </span>. </p> </td> 
     </tr> 
  ...
  <td class="stentry"> <p>Indique le mode d’encapsulation. </p> <p> <span class="codeph"> wrap | noWrap | nbWrap  </span> </p> <p> 
    <table id="simpletable_FF2510E029EC41E29BC30D9FC2923EA3"> 
     ...
     <tr class="strow"> 
      ...
      <td class="stentry"> <p>Activez le retour automatique à la ligne standard. </p> <p>Rompt les mots longs si nécessaire. <span class="codeph"> textPs= prend  </span> uniquement en charge le  <span class="codeph"> retour automatique à la ligne  </span>. </p> </td> 
     </tr> 
     <tr class="strow"> 
      <td class="stentry"> <p> <span class="codeph"> nbWrap  </span> </p> </td> 
      <td class="stentry"> <p>Activez le retour automatique à la ligne incessant. </p> <p>Ne casse jamais un mot, même s'il est tronqué à la fin. En règle générale, utilisé conjointement avec <span class="codeph"> autoRes </span> ou <span class="codeph"> maxRes </span> pour s’assurer que les mots longs ne sont jamais rompus. </p> </td> 
     </tr> 
    </table> </p> <p><span class="codeph"> renvoie à la fois les valeurs </span> et <span class="codeph"> et renvoie à la ligne </span> le retour automatique à la ligne sur les limites de mot et les tirets. </p> </td> 
 </tr> 
</table>
