...
<table id="simpletable_69D112F85FA24EFCA727B398DC8ED699"> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Décalage des pixels du coin supérieur gauche de l’image de la vue vers le coin supérieur gauche du rectangle de la vue (int, int), exprimé en pixels, après application de l’échelle <span class="varname"></span>. </p></td> 
 </tr> 
 <tr class="strow"> 
