...
<table id="simpletable_754F76EE00BF4129B07502647FF172B7"> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Décalage en pixels de l’ de  de ce calque vers l’de couche 0  (int, int). </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p><span class="varname"> coordN</span> </p></td> 
  <td class="stentry"> <p>Décalage normalisé de l’ de ce calque  au calque 0  (réel, réel). </p></td> 
 </tr> 
</table>

Dans le cas des calques d’image, de texte et de couleur unie, `pos=` indique la position d’un ancrage de calque par rapport à l’ancrage du calque 0. `posN=` les valeurs de coordonnées sont normalisées par rapport à la taille réelle du rect de calque 0.
...
`posN=0,0`. L’ancre de calque est alors placée au même emplacement que l’ancre de calque 0 s’il s’agit d’un calque d’image, de texte ou de couleur unie. Positionne un calque d’effets directement sur ou sous son calque parent.
...
[=](../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-origin.md#reference-e11c7ac06e2240cc884c3fec98f05138)
