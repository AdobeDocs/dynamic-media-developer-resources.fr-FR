---
description: Propriétés du catalogue d’images. Renvoie les attributs courants du catalogue d’images spécifiés dans le chemin d’accès à la requête.
seo-description: Propriétés du catalogue d’images. Renvoie les attributs courants du catalogue d’images spécifiés dans le chemin d’accès à la requête.
...
Propriétés du catalogue d’images. Renvoie les attributs courants du catalogue d’images spécifiés dans le chemin d’accès à la requête.
...
<table id="table_DEC26CBF274945298BA81B5E2E2F331D"> 
 <tbody> 
  ...
  <tr valign="top"> 
   ...
   <td> <p> chaîne </p> </td> 
   <td> <p> <span class="codeph"> attribut::LastModified</span>ou, s’il n’est pas présent, l’heure de dernière modification du <span class="varname"> fichier .ini</span><span class="filepath"> du catalogue</span> . </p> </td> 
  </tr> 
  <tr> 
