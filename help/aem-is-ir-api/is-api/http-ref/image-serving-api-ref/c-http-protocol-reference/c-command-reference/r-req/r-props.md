...
<table id="table_9665612ED7D24C07AAF75D953C0FEB36"> 
 <tbody> 
  ...
  <tr valign="top"> 
   ...
   <td> <p> sortilège </p> </td> 
   <td> <p> Couleur de fond (Voir <span class="codeph"> bgc= <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-bgc.md#reference-53376175f617446fbe5c69120f834b88" type="reference" format="dita" scope="local"> </a>.)</span> </p> </td> 
  </tr> 
  <tr valign="top"> 
  ...
  <tr valign="top"> 
   <td> <p> <span class="codeph"> longueur de l’image </span> </p> </td> 
   <td> <p> entier </p> </td> 
   <td> <p> Taille de réponse en pixels sans inclure l’en-tête HTTP ; 0 si les données de l’image de réponse n’ont pas été précédemment mises en cache par le serveur. (reportez-vous à la section <span class="codeph"> <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-req/r-req.md#reference-907cdb4a97034db7ad94695f25552e76" type="reference" format="dita" scope="local"> req=loadcache </a> </span>.) </p> </td> 
  </tr> 
  <tr valign="top"> 
   <td> <p> <span class="codeph"> image.mask </span> </p> </td> 
   <td> <p> enum </p> </td> 
   <td> <p> 1 si l’image de réponse comprend un canal alpha, 0 dans le cas contraire. </p> </td> 
  </tr> 
  <tr valign="top"> 
  ...
  <tr valign="top"> 
   ...
   <td> <p> entier </p> </td> 
   <td> <p> Qualité JPEG. (reportez-vous à la section <span class="codeph"> <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-is-http-qlt.md#reference-f69ed0758c784b0385d979820546d352" type="reference" format="dita" scope="local"> qlt= </a> </span>.) </p> </td> 
  </tr> 
  <tr valign="top"> 
   <td> <p> <span class="codeph"> image.type </span> </p> </td> 
   <td> <p> chaîne </p> </td> 
   <td> <p> Type MIME de l’image de réponse. (reportez-vous à la section <span class="codeph"> <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-is-http-fmt.md#reference-cdf10043423b45ba9fe15157fb3ae37a" type="reference" format="dita" scope="local"> fmt= </a> </span>.) </p> </td> 
  </tr> 
  <tr valign="top"> 
  ...
  <tr valign="top"> 
   ...
   <td> <p> chaîne </p> </td> 
   <td> <p> Identifiant de la version de l’image. (reportez-vous à la section <span class="codeph"> <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-id.md#reference-60661184deb3420998779724244fcfa0" type="reference" format="dita" scope="local"> id= </a> </span>.) </p> </td> 
  </tr> 
  <tr valign="top"> 
   <td> <p> <span class="codeph"> metadata.version </span> </p> </td> 
   <td> <p> chaîne </p> </td> 
   <td> <p> Identifiant de la version des métadonnées. (reportez-vous à la section <span class="codeph"> <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-id.md#reference-60661184deb3420998779724244fcfa0" type="reference" format="dita" scope="local"> id= </a> </span>.) </p> </td> 
  </tr> 
 </tbody> 
</table>

Les propriétés suivantes sont renvoyées pour `/is/content` les demandes :
...
<table id="table_B66360C475CE495D9701AB526E758873"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> chaîne </p> </td> 
   <td> <p>Chemin d’accès au fichier partiellement résolu. (Voir <span class="codeph"> statique ::P ath </span>.) </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td> <p> <span class="codeph"> Dernière modification </span> </p> </td> 
   <td> <p> chaîne </p> </td> 
   <td> <p> Date/heure de modification (à partir de static ::TimeStamp <span class="codeph"> ou du </span> fichier objet) </p> </td> 
  </tr> 
  <tr> 
   <td> <p> <span class="codeph"> Type d’utilisateur </span> </p> </td> 
   <td> <p> chaîne </p> </td> 
