...
Voir [Propriétés](../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-response-data/c-properties/c-properties.md#concept-49c609fd6de942cab422ee412353c9d9) pour une description de la syntaxe de la réponse et du type MIME de la réponse. La réponse HTTP peut être mise en cache avec un TTL basé sur `attribute::NonImgExpiration`.
