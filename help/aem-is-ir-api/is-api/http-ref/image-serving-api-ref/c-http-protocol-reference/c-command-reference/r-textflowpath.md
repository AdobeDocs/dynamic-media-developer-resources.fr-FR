---
description: Zone d’enchaînement de texte. Spécifie une ou plusieurs régions dans lesquelles le texte spécifié avec textPs= doit être enchaîné.
seo-description: Zone d’enchaînement de texte. Spécifie une ou plusieurs régions dans lesquelles le texte spécifié avec textPs= doit être enchaîné.
...
Zone d’enchaînement de texte. Spécifie une ou plusieurs régions dans lesquelles le texte spécifié avec textPs= doit être enchaîné.
...
Les commandes de marge RTF `\margl`, `\margr`, `\margt`et `\margb` sont ignorées lorsqu’elles `textFlowPath=` sont présentes. Si aucune définition de chemin n’est spécifiée, `textFlowPath=` est ignorée.
