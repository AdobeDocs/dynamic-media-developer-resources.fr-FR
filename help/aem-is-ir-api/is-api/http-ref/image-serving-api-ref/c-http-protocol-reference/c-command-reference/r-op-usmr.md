...
Les paramètres sont appliqués en l’état, que l’échantillonnage au sol ait été effectué ou non.
...
Attribut de calque ou attribut de  de. S’applique au calque actif ou à l’image de  finale du, le cas échéant `layer=comp`. Les calques d’effets l’ignorent.
