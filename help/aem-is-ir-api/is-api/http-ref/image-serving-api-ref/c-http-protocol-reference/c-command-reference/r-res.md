...
Si non spécifié, `scale=` ou `size=` détermine le facteur d’échelle ou, si aucun des deux n’est spécifié, l’image est utilisée sans mise à l’échelle.
