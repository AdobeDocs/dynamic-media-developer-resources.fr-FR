...
>[!NOTE]
>
>`rgn=` définit uniquement un retour sur investissement sans recadrer l’image. Si `wid=` et/ou `hei=` supérieur à la taille sont également appliqués, des données supplémentaires provenant de l’image composite peuvent être visibles dans l’image de réponse finale.
