...
La diffusion d’images fournit un mécanisme pour gérer les contenus autres que les images dans les catalogues et les diffuser via une `context /is/content` distincte. Le mécanisme permet de configurer le délai d’activation séparément pour chaque élément.
...
<table id="simpletable_4A6249F0C40747339524323EB0831CE4"> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p> <span class="codeph"> http://  <span class="varname"> server  </span>/is/content[/  <span class="varname"> catalogue  </span>/  <span class="varname"> élément  </span>][? <span class="varname"> modificateurs  </span>]  </span> </p> </td> 
 </tr> 
 <tr class="strow"> 
...
La diffusion d’images prend en charge les commandes suivantes sous /is/content :
