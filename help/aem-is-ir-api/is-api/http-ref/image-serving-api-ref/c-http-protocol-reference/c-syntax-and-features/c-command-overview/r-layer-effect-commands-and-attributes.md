...
Ces commandes permettent de définir des effets de calque, tels que des effets d’ombre portée ou d’éclat. Les calques d’effets ignorent toutes les autres commandes.
...
<table id="simpletable_3094B9783772437FAACF9B382F7A32EE"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Début le segment de calque d’effets et spécifie l’ordre z. </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Agrandit ou réduit l’effet de calque. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Ajoute le bruit à l’effet. </p></td> 
 </tr> 
 <tr class="strow"> 
