---
description: Ces commandes peuvent être utilisées pour définir des effets de calque, tels que des effets d’ombre portée ou de lueur. Les calques d’effet ignorent toutes les autres commandes.
...
Ces commandes peuvent être utilisées pour définir des effets de calque, tels que des effets d’ombre portée ou de lueur. Les calques d’effet ignorent toutes les autres commandes.
...
<table id="simpletable_3094B9783772437FAACF9B382F7A32EE"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Démarre le segment de calque d’effet et spécifie l’ordre de plan. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Indique comment utiliser le masque de calque du parent (couche alpha). </p></td> 
 </tr> 
 <tr class="strow"> 
