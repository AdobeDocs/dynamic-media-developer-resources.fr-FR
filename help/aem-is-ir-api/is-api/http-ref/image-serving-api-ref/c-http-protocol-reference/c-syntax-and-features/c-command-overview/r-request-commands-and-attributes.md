...
<table id="simpletable_3F7C17FB9E374EFDAD01EB24F57EC367"> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Remplace le comportement de mise en cache de la réponse par défaut. </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Incorpore des métadonnées XMP dans l’image de réponse. </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Indique les attributs de quantification des couleurs pour la sortie GIF. </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Identifiant de version de l’image/des métadonnées. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Spécifie la visionneuse d’images à utiliser pour cette requête. </p></td> 
 </tr> 
</table>
