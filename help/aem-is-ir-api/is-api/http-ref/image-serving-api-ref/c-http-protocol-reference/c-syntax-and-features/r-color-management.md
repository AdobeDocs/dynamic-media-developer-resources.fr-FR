...
La diffusion d’images inclut la plupart des profils ICC d’Adobe standard dans le catalogue d’images par défaut. Ces profils sont accessibles soit par leurs noms communs (comme dans Photoshop, par exemple), soit avec un identifiant un peu plus court. Le tableau suivant répertorie tous les profils ICC standard. Lorsque vous référencez un profil dans la variable `icc=` par son nom commun, les espaces doivent être codés comme `%20`.

Des profils supplémentaires peuvent être ajoutés aux profils standard, soit au catalogue par défaut, soit à un catalogue d’images spécifique. Voir [Référence de carte des profils ICC](../../../../../is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-icc-profile-map-reference/c-icc-profile-map-reference.md#concept-57b9148ce55249cd825cb7ee19ed057c) pour plus d’informations.
