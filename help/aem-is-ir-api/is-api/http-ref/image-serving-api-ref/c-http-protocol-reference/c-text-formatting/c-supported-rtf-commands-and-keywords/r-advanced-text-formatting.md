---
description: Utilisez les commandes suivantes pour une mise en forme avancée du texte.
seo-description: Utilisez les commandes suivantes pour une mise en forme avancée du texte.
...
Utilisez les commandes suivantes pour une mise en forme avancée du texte.
...
<table id="table_43B2EB887C0F471BB60C23B570E7D3D2"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Taille de police en demi-points, au-dessus de laquelle appliquer le crénage; 0 pour désactiver le crénage; la valeur par défaut est 1 pour le crénage de toutes les tailles de police sur ½ point. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>les quarts-points positifs ou négatifs; la valeur par défaut est 0. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>Nombre maximal de lignes d’ajustement de copie (limitation souple). </p> </td> 
   <td> <p>0 pour aucune limitation de ligne; <span class="codeph"> textPs= </span> uniquement; Extension Scene7. </p> </td> 
  </tr> 
  <tr> 
   <td> <span class="codeph"> \copyfitmaxlines <span class="varname"> N </span></span> </td> 
   <td> <p>Nombre maximal de lignes de copier-ajuster (troncature). </p> </td> 
