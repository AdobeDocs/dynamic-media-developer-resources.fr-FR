...
seo-description: Utilisez les commandes suivantes pour le formatage de base des caractères.
seo-title: Formatage de caractères de base
solution: Experience Manager
title: Formatage de caractères de base
...
# Formatage de caractères de base{#basic-character-formatting}
...
<table id="table_65415B84652F4E7497299AD90AE7C191"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>Réinitialisez la mise en forme des caractères par défaut. </p> </td> 
  ...
  <tr valign="top"> 
   ...
   <td> <p>Image Serving reconnaît également les commandes de soulignement RTF suivantes : </p> <p> 
     ...
     </ul> </p> <p>Elles sont actuellement mises en oeuvre sous la forme d’une norme <span class="codeph"> \ul </span> soulignée. Toutes les autres commandes de soulignement RTF sont ignorées. </p> </td> 
  </tr> 
  <tr> 
