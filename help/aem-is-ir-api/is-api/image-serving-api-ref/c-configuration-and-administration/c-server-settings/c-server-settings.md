...
seo-description: Cette section décrit tous les paramètres de configuration modifiables, regroupés par domaines d’intérêt.
...
* [Cache serveur](r-server-caches.md)
* [Limitations de taille d’image](r-image-size-limits.md)
...
* [Redirection d&#39;erreur](r-error-redirection.md)
...
* [SVG](r-svg.md)
* [Réponses des visionneuses de supports](r-media-set-responses.md)
