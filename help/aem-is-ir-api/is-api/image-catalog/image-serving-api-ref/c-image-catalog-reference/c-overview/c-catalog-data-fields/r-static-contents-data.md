---
description: Les champs suivants sont pris en charge pour les catalogues de contenu statiques (autres que des images).
seo-description: Les champs suivants sont pris en charge pour les catalogues de contenu statiques (autres que des images).
...
# Données de contenu statique{#static-contents-data}

Les champs suivants sont pris en charge pour les catalogues de contenu statiques (autres que des images).
...
<table id="simpletable_D1DEF6268BA744AD804B9BA3D9AEE800"> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Identifiant d’enregistrement du catalogue (clé d’index). </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Expiration (durée de vie) pour les réponses HTTP. </p></td> 
 </tr> 
 <tr class="strow"> 
