---
description: Les fichiers d’attributs de catalogue reconnaissent ces attributs de gestion des couleurs.
...
# Attributs de gestion des couleurs{#color-management-attributes}

Les fichiers d’attributs de catalogue reconnaissent ces attributs de gestion des couleurs.
...
<table id="simpletable_60EABACFB5B344D380B65891880BCB8B"> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Profil de couleurs de sortie CMJN par défaut. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Profil de couleurs de sortie en niveaux de gris par défaut. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Profil de couleur de sortie RVB par défaut. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Profil de couleurs d’entrée CMJN par défaut. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Profil de couleur d’entrée d’échelle de gris par défaut. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Profil de couleurs d’entrée RVB par défaut. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Intention de rendu par défaut. </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p><span class="codeph"><a href="../../../../../../is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-attributes-reference/r-iccblackpointcompensation.md#reference-357626375ee140d1807f0c05171c733f" type="reference" format="dita" scope="local"> Compensation de points IccBlackPoints</a> </span> </p></td> 
  <td class="stentry"> <p>Activer/désactiver la compensation du point noir. </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p><span class="codeph"><a href="../../../../../../is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-attributes-reference/r-iccdither.md#reference-914d0d0567364246b4016d45c0ada85b" type="reference" format="dita" scope="local"> IccLither</a> </span> </p></td> 
  <td class="stentry"> <p>Active/désactive le tramage de conversion des couleurs. </p></td> 
 </tr> 
</table>
