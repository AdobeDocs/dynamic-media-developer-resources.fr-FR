---
description: Les champs Catalogue utilisent ces valeurs par défaut.
solution: Experience Manager
title: Valeurs par défaut des champs du catalogue
...
# Valeurs par défaut des champs du catalogue{#defaults-for-catalog-fields}

Les champs Catalogue utilisent ces valeurs par défaut.
...
<table id="table_5942A2243DD946338B6B4640D6D9762F"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Informations par défaut sur l'image Digimarc. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Délai d’expiration par défaut du cache client. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Résolution de miniature par défaut. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Type de miniature par défaut. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Date et heure de modification de l’image par défaut. </p> </td> 
  </tr> 
 </tbody> 
</table>
