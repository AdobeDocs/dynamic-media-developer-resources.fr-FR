...
seo-description: Les champs de catalogue utilisent ces valeurs par défaut.
seo-title: Valeurs par défaut des champs de catalogue
...
# Valeurs par défaut des champs de catalogue {#defaults-for-catalog-fields}

Les champs de catalogue utilisent ces valeurs par défaut.
...
<table id="table_5942A2243DD946338B6B4640D6D9762F"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Informations d’image Digimarc par défaut. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Durée de vie par défaut du cache client. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Horodatage de modification d’image par défaut. </p> </td> 
  </tr> 
 </tbody> 
</table>
