---
description: Couleur d’arrière-plan par défaut. Valeur RGB utilisée pour remplir n’importe quelle zone d’une image de réponse qui ne contient pas de données d’image réelles.
...
Couleur d’arrière-plan par défaut. Valeur RGB utilisée pour remplir n’importe quelle zone d’une image de réponse qui ne contient pas de données d’image réelles.
