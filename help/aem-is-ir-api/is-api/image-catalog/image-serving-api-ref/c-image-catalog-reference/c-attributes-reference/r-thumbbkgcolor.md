---
description: Couleur d’arrière-plan par défaut des miniatures. Valeur RGB utilisée pour remplir la zone d’une miniature de sortie qui ne contient pas de données d’image réelles.
...
Couleur d’arrière-plan par défaut des miniatures. Valeur RGB utilisée pour remplir la zone d’une miniature de sortie qui ne contient pas de données d’image réelles.
