...
Tous les attributs sont obligatoires dans le fichier d’attributs de catalogue par défaut ( [!DNL default.ini]).
...
* [Expiration par défaut](r-defaultexpiration.md)
