---
description: Chemin d’accès racine des données source. Chemin d’accès absolu ou relatif du dossier racine pour les données source de ce catalogue d’images.
seo-description: Chemin d’accès racine des données source. Chemin d’accès absolu ou relatif du dossier racine pour les données source de ce catalogue d’images.
seo-title: RootPath
...
Chemin d’accès racine des données source. Chemin d’accès absolu ou relatif du dossier racine pour les données source de ce catalogue d’images.

Il `RootPath` s’agit d’une valeur de chaîne de texte. Voir [Gestion des données](../../../../../is-api/image-serving-api-ref/c-configuration-and-administration/c-managing-content/r-source-data.md#reference-4eebd51b2db2401c90be771d3382329e) source pour plus d’informations sur les chemins racine du serveur.
