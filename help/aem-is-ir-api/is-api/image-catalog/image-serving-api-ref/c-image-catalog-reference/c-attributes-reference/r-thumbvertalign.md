---
description: Alignement vertical des miniatures. Indique l’alignement vertical de l’image miniature dans le rectangle de l’image de réponse spécifié par les valeurs wid= et hei= ou par l’attribut DefaultThumbPix.
...
Alignement vertical des miniatures. Indique l’alignement vertical de l’image miniature dans le rectangle de l’image de réponse spécifié par les valeurs wid= et hei= ou par l’attribut::DefaultThumbPix.

Utilisé uniquement pour les requêtes de miniature ( `req=tmb`).

## Propriétés {#section-f02c23248e87419caf3d95add51aea1e}

Énumération. Les valeurs autorisées sont 1, 2 et 3 pour l’alignement en haut, au centre et en bas, respectivement.
