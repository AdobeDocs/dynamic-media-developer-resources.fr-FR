...
Les valeurs *`locSuffix`* vides sont autorisées. *`locSuffix`* Les valeurs doivent être triées dans l’ordre dans lequel elles doivent être recherchées. La première correspondance est renvoyée.
