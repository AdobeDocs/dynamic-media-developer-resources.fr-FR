...
seo-description: Attributs de codage JPEG par défaut. Spécifie les attributs par défaut des images de réponse JPEG.
...
Nombre entier et indicateur, séparés par une virgule. La première valeur se trouve dans la plage 1.100 et définit la qualité. La seconde valeur peut être 0 pour le comportement normal, ou 1 pour désactiver le sous-échantillonnage chromatique RVB généralement utilisé par les encodeurs JPEG.
