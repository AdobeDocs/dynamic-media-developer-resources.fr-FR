...
Chaîne de texte. Facultatif. Clé d’index Secondaire pour la mise en correspondance des polices. Identique `font::PsName` ne peut se produire qu’une seule fois dans le même fichier de mappage de polices.
