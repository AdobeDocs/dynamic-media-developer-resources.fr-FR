...
Chaîne de texte. Facultatif. Clé d’index Secondaire pour la mise en correspondance des polices. La même valeur `font::PsName` ne peut se produire qu’une seule fois dans le même fichier de mappage des polices.
