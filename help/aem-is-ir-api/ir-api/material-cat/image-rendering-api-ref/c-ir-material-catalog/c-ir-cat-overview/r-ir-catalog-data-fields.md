...
<table id="simpletable_C2D795844F624470871959842AF50BF3"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Identifiant du matériau (clé d’index). </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Horodatage de modification des matières. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Expiration du cache client (intervalle de durée de vie). </p></td> 
 </tr> 
</table>

<table id="simpletable_58980295E92848B7BE471855D629F756"> 
 <thead class="sthead"> 
  <td class="stentry"> <p>Attributs de matière </p></td> 
  <td class="stentry"> <p>Description </p></td> 
 </thead> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Chemin ou URL du fichier de données Secondaire. </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p></a> de résolution <a href="../../../../../ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-material-data-reference/r-ir-resolution-dataref.md#reference-6a2d64c2d72b438fade58a3391569da7" type="reference" format="dita" scope="local"> </p></td> 
  <td class="stentry"> <p>Résolution de l’image. </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p></a> d’ancrage <a href="../../../../../ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-material-data-reference/r-ir-cat-anchor.md#reference-d9b1d49db1fc440686f64b84453297ab" type="reference" format="dita" scope="local"> </p></td> 
  <td class="stentry"> <p>Point d’ancrage de texture/décalque (zone réactive). </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p></a> de couleur <a href="../../../../../ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-material-data-reference/r-ir-cat-color.md#reference-7639487fe0ac48beb9e8afa4dc845552" type="reference" format="dita" scope="local"> </p></td> 
  <td class="stentry"> <p>Couleur du matériau. </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p></a> <a href="../../../../../ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-material-data-reference/r-ir-basecolor.md#reference-5f02371b1d8e444ab12d2614d9792de8" type="reference" format="dita" scope="local"> BaseColor </p></td> 
  <td class="stentry"> <p>Couleur soustractive pour un matériau colorable. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Sélecteur de carte d'illumination. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Brillance de la surface. </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p></a> de rugosité <a href="../../../../../ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-material-data-reference/r-ir-roughness.md#reference-79f748ac642745e3b81795a99f61fa99" type="reference" format="dita" scope="local"> </p></td> 
  <td class="stentry"> <p>Rugosité de surface. </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p>Type de </a> <a href="../../../../../ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-material-data-reference/r-ir-cat-type.md#reference-9bea147dda9f4e74bc0ec79dcc0d9161" type="reference" format="dita" scope="local"></p></td> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Accentuation de la texture/décalque. </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p><a href="../../../../../ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-material-data-reference/r-ir-cat-repeat.md#reference-20e149211e1f4e8285db5ecb83c1902e" type="reference" format="dita" scope="local"> Répéter</a> </p></td> 
  <td class="stentry"> <p>Mode de répétition pour les textures répétables </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p>Alignement des </a> <a href="../../../../../ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-material-data-reference/r-ir-alignment.md#reference-e52152e8dc244d0aa13b40c615d0f399" type="reference" format="dita" scope="local"></p></td> 
  <td class="stentry"> <p>Alignement de la texture entre les objets. </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p>Taille de la </a> <a href="../../../../../ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-material-data-reference/r-ir-cat-size.md#reference-a698b0d2652f4ea8a2b006fbf59cf4f1" type="reference" format="dita" scope="local"></p></td> 
  <td class="stentry"> <p>Taille de calque de décalque/superposition. </p></td> 
 </tr> 
 <tr class="strow"> 
...
<table id="simpletable_BD278D96C3324004ABBBACEDF85F8D50"> 
 <thead class="sthead"> 
  <td class="stentry"> Cartes Vignette</td> 
  <td class="stentry"> <p>Description </p></td> 
 </thead> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Identifiant de la vignette (index key). </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Horodatage de modification de la vignette. </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  <td class="stentry"> <p>Chemin <a href="../../../../../ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-vignette-map-reference/r-ir-path-vignette.md#reference-aa1c007b63a04351b89881933deaf59c" type="reference" format="dita" scope="local">’accès </a> </p></td> 
  <td class="stentry"> <p>Chemin du fichier Vignette. </p></td> 
 </tr> 
 <tr class="strow"> 
...
<table id="simpletable_B722319F81FB4DDA9AC16B27448B8F04"> 
 <thead class="sthead"> 
  <td class="stentry"> Définitions des macros</td> 
  <td class="stentry"> <p>Description </p></td> 
 </thead> 
 <tr class="strow"> 
...
Les champs suivants sont reconnus dans les fichiers de carte de profil colorimétrique ICC :
...
<table id="simpletable_54ED156EDA394412B5C4C49AA3A32828"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Chemin d’accès au fichier de profil de couleurs ICC. </p></td> 
 </tr> 
</table>
