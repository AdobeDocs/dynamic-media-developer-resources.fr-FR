...
Chaîne de texte. Facultatif pour tous les matériaux. S’il est spécifié, il doit s’agir d’une chaîne de paramètres de rendu valide, telle que définie avec l’outil de création de vignettes (qui fait partie du package de création d’images Dynamic Media).

## Par défaut {#section-6a4d2013c1d34284b4ff21bb07485d28}

`attribute::RenderSettings` si non renseigné ou si vide.
