...
description: Profil de couleurs d’entrée par défaut de RGB. Indique le nom du profil de couleurs ICC à utiliser pour les images et les vignettes RGB qui n’incorporent pas de profil de couleurs. Également pour les valeurs de couleur RGB spécifiées avec diverses commandes de rendu d’image, telles que bgc= et color=.
...
Profil de couleurs d’entrée par défaut de RGB. Indique le nom du profil de couleurs ICC à utiliser pour les images et les vignettes RGB qui n’incorporent pas de profil de couleurs. Également pour les valeurs de couleur RGB spécifiées avec diverses commandes de rendu d’image, telles que `bgc=` et `color=`.
