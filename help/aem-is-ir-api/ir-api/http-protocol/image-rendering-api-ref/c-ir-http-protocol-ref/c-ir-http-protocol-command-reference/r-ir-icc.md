...
<table id="simpletable_DF1914FD351E4F2BA61372A52F0CFFBF"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>perception | relative | saturation | absolute </p></td> 
 </tr> 
 <tr class="strow"> 
...
*`profile`* Spécifie le profil d’espace colorimétrique de sortie auquel l’image rendue doit être convertie si elle est différente du profil de travail. *`profile`* Doit être soit un `icc::Name` valide défini dans la carte de profil ICC d’un catalogue d’images ou d’un catalogue par défaut, soit un chemin d’accès relatif à un fichier de profil (généralement avec le suffixe [!DNL `.icc`] ou [!DNL `.icm`]).

>[!NOTE]
>
>*`profile`* Peut ne pas inclure de caractères &quot;,&quot;, même s’ils sont codés en HTTP.
