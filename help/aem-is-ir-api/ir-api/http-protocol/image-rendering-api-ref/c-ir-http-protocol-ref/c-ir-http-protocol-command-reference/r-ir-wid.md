---
title: éolien
description: Largeur de l’image de réponse. Indique la mise à l’échelle de l’image rendue afin que l’image de réponse ne dépasse pas la valeur spécifiée, tout en conservant les proportions de l’image.
...
Largeur de l’image de réponse. Indique la mise à l’échelle de l’image rendue afin que l’image de réponse ne dépasse pas la valeur spécifiée, tout en conservant les proportions de l’image.
...
L’image n’est pas complétée si `wid=` et `hei=` sont spécifiés et `wid`/`hei` est différent du rapport d’aspect de l’image.
