...
<table id="simpletable_04B4EAA7CE7D4ED48A61A50CD001388F"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>0 accentuation en alternance (précoce). </p> </td> 
 </tr> 
 <tr class="strow"> 
...
L’algorithme d’accentuation et le degré d’accentuation, ainsi que d’autres paramètres USM (masquage flou) sont contrôlés par le modèle de matériau par défaut fourni par la vignette ou avec `rs=`.

## Propriétés {#section-498ec9fcb8eb415fb99532d36c11d4c7}

Attribut Material. Ignoré par les matériaux de couleur unie.
