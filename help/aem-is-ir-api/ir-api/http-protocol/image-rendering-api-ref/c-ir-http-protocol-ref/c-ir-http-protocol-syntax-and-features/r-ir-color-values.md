...
description: Les valeurs de couleur pour les attributs color= et bgc= peuvent être spécifiées à l’aide d’une liste de valeurs de composant décimales séparées par des virgules ou d’une notation hexadécimale, similaire à HTML.
...
Les valeurs de couleur des attributs `color=` et `bgc=` peuvent être spécifiées à l’aide d’une liste de valeurs de composant décimales séparées par des virgules ou d’une notation hexadécimale, similaire à HTML.
...
<table id="simpletable_9B3A231D5BB14A3DB2B42B341E198341"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Valeur de couleur grise hexadécimale à deux chiffres empaquetée (0...FF). </p></td> 
 </tr> 
</table>

## Exemples {#section-a78732151d584e84abeb99f9ce8d7c24}

Quelques exemples de spécificateurs de couleurs valides et leur interprétation de valeur de couleur RGB correspondante :
