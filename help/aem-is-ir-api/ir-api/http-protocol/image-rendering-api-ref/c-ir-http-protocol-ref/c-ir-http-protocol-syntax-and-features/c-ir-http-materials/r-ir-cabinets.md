---
description: Les documents Armoires spécifient un fichier de style Armoire (.vnc file extension), un fichier de données spécial contenant des représentations photographiques des armoires, ainsi que des définitions de disposition paramétrique et d'autres informations requises pour le rendu des façades de l'armoire.
seo-description: Les documents Armoires spécifient un fichier de style Armoire (.vnc file extension), un fichier de données spécial contenant des représentations photographiques des armoires, ainsi que des définitions de disposition paramétrique et d'autres informations requises pour le rendu des façades de l'armoire.
seo-title: Meubles
...
[!DNL vnc] les fichiers peuvent inclure une texture de grain de bois répétable, ou la texture peut être fournie à l’extérieur par l’intermédiaire d’un second argument à `src=`. Certains [!DNL vnc] fichiers permettent de coloriser ou de texturer certaines zones des façades de l&#39;armoire (généralement utilisées pour les styles d&#39;armoire laminée).
