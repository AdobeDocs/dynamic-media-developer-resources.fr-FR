---
description: Les matériaux décoratifs incluent des vêtements tels que des appliqués, des t-shirts imprimés et des logos brodés ou imprimés, ainsi que des objets plats non répétables utilisés à l’intérieur ou à l’extérieur, tels que des tapis, des peintures murales, des panneaux, etc.
...
Les matériaux décoratifs incluent des vêtements tels que des appliqués, des t-shirts imprimés et des logos brodés ou imprimés, ainsi que des objets plats non répétables utilisés à l’intérieur ou à l’extérieur, tels que des tapis, des peintures murales, des panneaux, etc.
...
Un décal peut être appliqué à chaque objet plat, de contour, de plan ou de mur (sauf si l’indicateur &quot;Pas de texture&quot; est défini). Les décimales sont appliquées à l’objet en alignant la balise `anchor=` de la balise avec le point d’origine de la balise de vignette. La position peut être ajustée avec `pos=`.
