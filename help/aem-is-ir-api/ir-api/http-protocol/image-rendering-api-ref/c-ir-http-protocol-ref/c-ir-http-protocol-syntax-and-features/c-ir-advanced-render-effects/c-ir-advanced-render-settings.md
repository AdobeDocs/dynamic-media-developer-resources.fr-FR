---
description: L’outil de création de vignettes (inclus dans le pack de création d’images de Scene7) fournit des mécanismes de contrôle des aspects de bas niveau du moteur de rendu de vignette.
seo-description: L’outil de création de vignettes (inclus dans le pack de création d’images de Scene7) fournit des mécanismes de contrôle des aspects de bas niveau du moteur de rendu de vignette.
seo-title: Paramètres de rendu avancé
solution: Experience Manager
title: Paramètres de rendu avancé
...
# Paramètres de rendu avancé{#advanced-render-settings}

L’outil de création de vignettes (inclus dans le pack de création d’images de Scene7) fournit des mécanismes de contrôle des aspects de bas niveau du moteur de rendu de vignette.

>[!NOTE]
>
>Les paramètres de rendu sont une fonctionnalité avancée de rendu d’image et de création d’images. Contactez le support technique d’Adobe ou votre représentant Adobe pour obtenir une formation, une consultation ou les deux, sur l’utilisation des paramètres de rendu.

Ces paramètres sont contrôlés de manière interactive dans la création d’images. Il est possible d’appliquer les mêmes paramètres dans le rendu d’image à l’aide de la `rs=` commande (ou avec la `catalog::RenderSettings` valeur). Ce mécanisme permet de sélectionner différentes options d’accentuation pour chaque matériau et de modifier le comportement des algorithmes de rendu de l’éclairage, comme la variation de la saturation des tons clairs ou le contraste des tons foncés.
...
<table id="table_1517FC39C7344EBB9F17BE20415DB057"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>USM (Masque non Sharp). </p> </td> 
   <td colname="col3"> <p>01 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Indemnité de luminosité (case à cocher) </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p>a </p> </td> 
   <td colname="col2"> <p>Indemnité de luminosité. </p> </td> 
   <td colname="col3"> <p>01 </p> </td> 
   <td colname="col4"> <p>255 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Ajustement des surbrillances. </p> </td> 
   <td colname="col3"> <p>01 </p> </td> 
   <td colname="col4"> <p>255 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Mettre en surbrillance le décalage de la teinte. </p> </td> 
   <td colname="col3"> <p>01 </p> </td> 
   <td colname="col4"> <p>255 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Valeurs par défaut dans la création d’images. 
     <ul id="ul_AA7CF1A3E6984B318265BBE8FFFBB4EE">
      ...
      <li id="li_376C275FDB3548958C09BD266C77318F">J10 = Saturation des surbrillances (0-50). </li> 
      ...
      <li id="li_949B6DB4959B46A892787CD5B3AD7485">W100 = montant USM (1 %-500 %). </li> 
      <li id="li_F39D3834D4A2478D993E5E9C9B434CFE">X0 = seuil USM (niveaux 0 à 255). </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7C374842312E4AD0B62692BBCE6743A8"> 
      ...
      <li id="li_C2801B2C093444AC9401793BC571EC27">I70 = Faits saillants </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Autre ombrage avec accentuation : </p> <p> 
     <ul id="ul_93AD53BB37EA47F6A3CEE424D3AAE18C"> 
      ...
      <li id="li_E5ED76998C0543D8A3F9AD178CFD3C2C">Rééchantillonnage (échantillonnage en trop, aléatoire=moitié, rate=moitié) </li> 
      <li id="li_CCEE53544E7D48858398BF3168F1E87D">Contraste (plus fort) </li> 
      <li id="li_EB0D25C095FB4D5798AC031AB759849B">Réglage de la saturation (premier sommet au milieu, deuxième sommet le long du bord, troisième sommet au milieu du bas) </li> 
