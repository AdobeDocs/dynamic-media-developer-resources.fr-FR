...
description: L’outil de création de vignette (qui fait partie du package de création d’images Dynamic Media) fournit des mécanismes pour contrôler les aspects de bas niveau du moteur de rendu de vignette.
...
L’outil de création de vignette (qui fait partie du package de création d’images Dynamic Media) fournit des mécanismes pour contrôler les aspects de bas niveau du moteur de rendu de vignette.

>[!NOTE]
>
>Les paramètres de rendu sont une fonctionnalité avancée de rendu d’image et de création d’images. Contactez le support technique d’Adobe ou votre représentant Adobe pour toute formation, consultation ou les deux, sur l’utilisation des paramètres de rendu.

Ces paramètres sont contrôlés de manière interactive dans la création d’images. Il est possible d’appliquer les mêmes paramètres dans le rendu d’image à l’aide de la commande `rs=` (ou avec la valeur `catalog::RenderSettings`). Ce mécanisme permet de sélectionner différentes options d&#39;accentuation pour chaque matériau et de modifier le comportement des algorithmes de rendu d&#39;illumination, comme la variation de la saturation des tons clairs ou le contraste des ombres.

## Valeurs des paramètres avancés de rendu (rs=) {#section-d9e7f341ebd44f07a4e90f1f5910726b}
...
<table id="table_1517FC39C7344EBB9F17BE20415DB057"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Montant total (%). </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Rayon de l’USM (pixels). </p> </td> 
   <td colname="col3"> <p>1 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col5"> <p> 
     <ul id="ul_87184BB93E7F46D59BA1AAAFA8455512"> 
      ...
      <li id="li_42ACFCE65B4843ACAFA6A52255364642">Sur-échantillonnage (valeur par défaut) </li> 
  ...
  <tr> 
   <td colname="col1"><b>Effets de rendu (ancien ombrage)</b> </td> 
   <td colname="col2"> </td> 
   <td colname="col3"> </td> 
   <td colname="col4"> </td> 
   <td colname="col5"> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Ombres pour les matériaux brillants. </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Force d’extrapolation basée sur le brillant. </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col5"> <p>La valeur par défaut est activé (vide) et désélectionné = F100G0. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
  ...
  <tr> 
   <td colname="col1"><b>Nuanceur alternatif</b> </td> 
   <td colname="col2"> </td> 
   <td colname="col3"> </td> 
   <td colname="col4"> </td> 
   <td colname="col5"> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Amplification à faible saturation. </p> </td> 
   <td colname="col3"> <p> </p> </td> 
   <td colname="col4"> <p> </p> </td> 
   <td colname="col5"> <p> </p> </td> 
  </tr> 
...
## Exemples de paramètres de rendu avancés {#section-56528569eae44ecd997a289b211ff256}

<table id="table_062DCF66ACCC4A6997E3CA951C0A12B8"> 
 <thead> 
  <tr> 
   <th colname="col1" class="entry"> <p>Définition de la composition </p> </th> 
   <th colname="col2" class="entry"> <p>Description </p> </th> 
  </tr>
 </thead>
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Valeurs par défaut dans la création d’images. 
     <ul id="ul_AA7CF1A3E6984B318265BBE8FFFBB4EE">
      ...
      <li id="li_F760B65E057146A7B56673D6B1A9A304">I30 = Surlignages (0-100). </li> 
      <li id="li_376C275FDB3548958C09BD266C77318F">J10 = Surligne la saturation (0-50). </li> 
      <li id="li_FE26429972F544869CDFE2DD61F39CC5">K200 = saturation des ombres (0-400). </li> 
      <li id="li_FB6BAA708427428AA4A3AC2E5D3B9932">L400 = force d’extrapolation basée sur le brillant (100-600). </li> 
      ...
      <li id="li_949B6DB4959B46A892787CD5B3AD7485">W100 = somme des montants (1 %-500 %). </li> 
      <li id="li_F39D3834D4A2478D993E5E9C9B434CFE">X0 = seuil USM (0-255 niveaux). </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_C6E6DD90ECAB4D2B9284A25A29923DC6"> 
      ...
      <li id="li_A003B68023424DCABBF3A2CAF98C39A4">Toute compensation maximale et de luminosité est activée. </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_AAEC098CED1C436E933B1C1B88DFB659"> 
      ...
      <li id="li_E36886FB1D00444CBA19D7245E89B292">Toute compensation maximale et de luminosité est désactivée. </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_6BB668C6C055493DAAA38F4D3B9C20A7"> 
      ...
      <li id="li_DA685F4DE4BA427BA7BE241A75C96152">Toute compensation maximale et de luminosité est désactivée. </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7C374842312E4AD0B62692BBCE6743A8"> 
      <li id="li_CC730580B54741FBBBFF507DE0FE1F15">H80 = somme des montants </li> 
      <li id="li_C2801B2C093444AC9401793BC571EC27">I70 = Surlignages </li> 
      <li id="li_518C6A690EC34614B0806A0C6BC535FF">J40 = Surligne la saturation </li> 
      <li id="li_F280CF29D1E341D9AC9C0C16C2DEA1E6">L300 = force d'extrapolation basée sur le brillant </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Alterner le nuanceur avec l'accentuation : </p> <p> 
     <ul id="ul_93AD53BB37EA47F6A3CEE424D3AAE18C"> 
      <li id="li_9EF1DF4167164721882E4842C2E0B20C">USM1 </li> 
      <li id="li_7B5D8B7BB5544E7FA4AD702EE281086B">Montant de l'USM (120) </li> 
      ...
      <li id="li_E5ED76998C0543D8A3F9AD178CFD3C2C">Rééchantillonnage (sur-échantillonnage, aléatoire=moitié, taux=moitié) </li> 
      <li id="li_CCEE53544E7D48858398BF3168F1E87D">Contraste (plus fort) </li> 
      <li id="li_EB0D25C095FB4D5798AC031AB759849B">Réglage de la saturation (premier sommet au milieu, deuxième sommet le long de l'arête, troisième sommet au milieu, point bas) </li> 
