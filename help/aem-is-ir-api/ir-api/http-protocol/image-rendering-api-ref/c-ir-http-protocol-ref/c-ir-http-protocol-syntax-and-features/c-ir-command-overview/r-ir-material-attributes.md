...
<table id="simpletable_EA046B0CD2EA4FD881A7EC2A0D2D246D"> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Chemins des fichiers image/données ou spécificateur de matière. </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  <td class="stentry"> <p><span class="codeph"> <a href="../../../../../../ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-http-gloss.md#reference-325aef2ee51e4e1584a06047427340ca" type="reference" format="dita" scope="local"> gèle</a></span> </p></td> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Epaisseur et couleur du sol en mosaïque. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>L'opacité matérielle. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Position de la décision. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Angle de rotation de la texture/du décal. </p></td> 
 </tr> 
 <tr class="strow"> 
