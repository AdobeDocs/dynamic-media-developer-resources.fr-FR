...
<table id="simpletable_D30C7420AECD44ADBD7B0728594FF5FA"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Applique à l’image rendue la largeur spécifiée. </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Mode de ré-échantillonnage pour la mise à l’échelle finale de l’image. </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p><span class="codeph"> <a href="../../../../../../ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-http-sharpen.md#reference-13034d22d176483cb99ccafc2a4f6a6e" type="reference" format="dita" scope="local"> accentuation</a></span> </p></td> 
  <td class="stentry"> <p>Accentuation de l’image de réponse. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p> de couleurs de sortie. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Incorporez le  de couleurs dans l’image de réponse. </p></td> 
 </tr> 
 <tr class="strow"> 
