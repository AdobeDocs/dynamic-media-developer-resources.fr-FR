...
seo-description: Ces commandes sont indépendantes de la position et peuvent se produire n’importe où dans une requête.
seo-title: Attributs de vue
solution: Experience Manager
title: Attributs de vue
...
# Attributs de vue{#view-attributes}
...
<table id="simpletable_D30C7420AECD44ADBD7B0728594FF5FA"> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Format d’image de réponse. </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Applique une mise à l’échelle de l’image rendue à la hauteur spécifiée. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Applique une mise à l’échelle de l’image rendue à la largeur spécifiée. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Applique une mise à l’échelle de l’image rendue par rapport à la taille de vignette en pleine résolution. </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Accentuation de l’image en réponse. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Profil de couleur de sortie. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Incorporez le profil de couleur dans l’image de réponse. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Incorporer les chemins Photoshop dans l’image de réponse. </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Remplacez le comportement de mise en cache des réponses par défaut. </p></td> 
 </tr> 
</table>
