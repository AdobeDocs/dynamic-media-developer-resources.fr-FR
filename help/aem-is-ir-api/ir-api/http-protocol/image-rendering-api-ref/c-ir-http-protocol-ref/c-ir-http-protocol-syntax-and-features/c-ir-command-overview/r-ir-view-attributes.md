...
# Afficher les attributs{#view-attributes}

Ces commandes sont indépendantes de la position et peuvent se produire n’importe où dans une requête.
...
<table id="simpletable_D30C7420AECD44ADBD7B0728594FF5FA"> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Format de l’image de réponse. </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Valeur de résolution d’impression incorporée dans l’image de réponse. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Mettez à l’échelle l’image rendue à la hauteur spécifiée. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Mettez à l’échelle l’image rendue à la largeur spécifiée. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Mettez à l’échelle l’image rendue par rapport à la taille de la vignette en pleine résolution. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Mode de rééchantillonnage pour la mise à l’échelle finale de l’image. </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p><span class="codeph"> <a href="../../../../../../ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-http-sharpen.md#reference-13034d22d176483cb99ccafc2a4f6a6e" type="reference" format="dita" scope="local"> accentuer</a></span> </p></td> 
  <td class="stentry"> <p>Accentuation des images de réponse. </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p><span class="codeph"> <a href="../../../../../../ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-icc.md#reference-86a2fff3cef24982ad2063d977a16e06" type="reference" format="dita" scope="local"> cpi</a></span> </p></td> 
  <td class="stentry"> <p>Profil de couleurs de sortie. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Incorporez le profil de couleurs dans l’image de réponse. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Incorporez les chemins Photoshop dans l’image de réponse. </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Remplacez le comportement de mise en cache de la réponse par défaut. </p></td> 
 </tr> 
</table>
