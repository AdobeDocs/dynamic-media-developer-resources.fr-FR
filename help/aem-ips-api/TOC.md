...
user-guide-description: L'API Service Web IPS (Image Production System) permet aux applications externes et aux développeurs tiers d'accéder par programmation aux ressources et fonctionnalités d'IPS.
...
+ Types de données {#data-types}
   ...
   + [Options de recadrage automatique des couleurs](types/c-data-types/r-auto-color-crop-options.md)
   + [AutomatedSetGenerationJob](types/c-data-types/r-automated-set-generation-job.md)
   + [OptionsCréationAutoSet](types/c-data-types/r-auto-set-creation-options.md)
   + [AutoTransparentCropOptions](types/c-data-types/r-auto-transparent-crop-options.md)
   + [Mise à jour des métadonnées de lot](types/c-data-types/r-batch-metadata-update.md)
   ...
   + [OptionsGestionCouleur](types/c-data-types/r-color-management-options.md)
   ...
   + [Appartenance à une société](types/c-data-types/r-company-membership.md)
   ...
   + [ExclureByproductCondition](types/c-data-types/r-exclude-byproduct-condition.md)
   + [ExclureMasterVideoFromAVS](types/c-data-types/r-exclude-master-video-from-avs.md)
   ...
   + [Options de recadrage manuel](types/c-data-types/r-manual-crop-options.md)
   ...
   + [AnnulerCompressionOptions](types/c-data-types/r-uncompress-options.md)
   ...
   + [TéléchargerPostJob](types/c-data-types/r-upload-post-job.md)
...
+ Constantes de chaîne {#sting-constants}
   ...
   + [États de travail principaux](string-constants/c-string-constants/r-active-job-states.md)
   ...
   + [Types de fichiers journaux de tâches](string-constants/c-string-constants/r-job-log-file-types.md)
   + [Champs de tri du journal des tâches](string-constants/c-string-constants/r-job-log-sort-fields.md)
   + [Types de journaux de tâches](string-constants/c-string-constants/r-job-log-types.md)
   ...
   + [Etat de la corbeille](string-constants/c-string-constants/r-trash-state.md)
...
+ Valeurs par défaut {#faults}
   + [Présentation des défauts](faults/c-faults/c-faults.md)
