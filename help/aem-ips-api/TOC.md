...
+ Méthodes d&#39;opération {#operation-methods}
   ...
   + Paramètres d&#39;opération {#operation-parameters}
      ...
      + [getAllEntreprises](operations/c-operations-intro/c-methods/r-get-all-companies.md)
...
+ Types de données {#data-types}
   ...
   + [Paramètres de la société](types/c-data-types/r-company-settings.md)
...
+ Constantes de chaîne {#sting-constants}
   ...
   + [Types de logs de traitement](string-constants/c-string-constants/r-job-log-types.md)
   ...
   + [Types de champ de métadonnées](string-constants/c-string-constants/r-metadata-field-types.md)
   + [Opérateurs de comparaison de dates/numériques](string-constants/c-string-constants/r-numeric-date-comparison-operators.md)
   + [Processus du PDF](string-constants/c-string-constants/r-pdf-processes.md)
   ...
   + [Champs de filtre Char d’utilisateur](string-constants/c-string-constants/r-user-char-filter-fields.md)
