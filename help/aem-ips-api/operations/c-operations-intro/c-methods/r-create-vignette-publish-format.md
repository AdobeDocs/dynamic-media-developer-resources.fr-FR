...
Les formats de vignette spécifient la taille des vignettes publiées et leurs miniatures, ainsi que les niveaux de zoom, les paramètres d’accentuation et la version du format de fichier des vignettes générées à partir de vignettes principales publiées sur un serveur de rendu d’images à partir d’IPS.
