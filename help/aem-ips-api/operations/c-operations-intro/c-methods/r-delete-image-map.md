...
|---|---|---|---|
| ` *`companyHandle`*` | `xsd:string` | Oui | Poignée vers le qui contient la zone cliquable à supprimer. |
...
Cet exemple de code supprime une zone cliquable d’un . Vous devez obtenir la poignée de zone cliquable à partir d’une autre opération.
