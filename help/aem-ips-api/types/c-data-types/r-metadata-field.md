...
Récupérez les définitions de champ de balise avec les `getMetadataFields` ou `getAssetMetadataField` les opérations.
...
<table id="table_04100BB8ABD84EF68B0A7CE3AD946414"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col3"> Poignée du champ de métadonnées. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <span class="codeph"> <span class="varname"> estObligatoire</span></span> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"><span class="codeph"> xsd:boolean</span> </td> 
   <td colname="col3">Masquez ou affichez les métadonnées spécifiques au système IPS. Renvoyé à partir de <a href="../../operations/c-operations-intro/c-methods/r-get-metadata-fields.md#reference-170337127801401d9ea54bd4ccf28efe" format="dita" scope="local"> getMetadataFields</a> et <a href="../../operations/c-operations-intro/c-methods/r-get-asset-metadata-fields.md#reference-ea57f8e98d3e443da66114550b0d0a28" format="dita" scope="local"> getAssetMetadataFields</a>. </td> 
  </tr> 
  <tr> 
   <td colname="col1"><span class="codeph"><span class="varname"> isEnered</span></span> </td> 
   <td colname="col2"><span class="codeph"> xsd:boolean</span> </td> 
   <td colname="col3"> <p>Indicateur booléen indiquant si le type de champ de métadonnées est appliqué (validé) lorsque la valeur est définie. </p> <p>Si la valeur est définie sur true, une erreur est générée si une valeur non autorisée est définie dans <span class="codeph"> setAssetMetadata</span> /<span class="codeph"> batchSetAssetMetadata</span>. </p> </td> 
  </tr> 
  <tr> 
