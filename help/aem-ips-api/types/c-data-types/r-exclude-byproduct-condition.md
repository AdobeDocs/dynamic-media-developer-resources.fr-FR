...
|---|---|---|
| [!DNL engine] | `xsd:string` | Moteur de génération qui a créé les ressources à exclure. Voir Informations de génération pour connaître les valeurs. |
| generateAssetType | `xsd:string` | Type de ressource exclu. Voir Types de ressources pour les valeurs. |
