---
description: Objet ou dans la hiérarchie de dossiers.
seo-description: Objet ou dans la hiérarchie de dossiers.
seo-title: Fichier
...
Objet ou dans la hiérarchie de dossiers.
...
<table id="table_C58EF9963CB34179A9D6C9F0F6FF24F2"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> xsd:string</span> </td> 
   <td colname="col3">Renvoie le nom du fichier virtuel. Le chemin d’accès complet au fichier virtuel est dossier <span class="codeph"> +</span>nomde fichier<span class="codeph"></span>. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> Propriétés d’un fichier de ICC . </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> xsd:string</span> </td> 
   <td colname="col3"> URL relative représentant un  miniature de la ressource. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> Propriétés d’un fichier de de calques . </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> Tableau des valeurs de métadonnées associées au fichier. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> type:PdfSettingsInfo</span> </td> 
   <td colname="col3"> Propriétés d’un fichier de paramètres PDF. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="codeph"> <span class="varname"> autorisations</span></span> </td> 
   <td colname="col2"> <span class="codeph"> Expression de code </span> </td> 
   <td colname="col3"> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> xsd:string</span> </td> 
   <td colname="col3">  de noms de projet. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> Propriétés d’un fichier de scène de rendu. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> xsd:string</span> </td> 
   <td colname="col3">Sous-type de fichier générique qui prend en charge les valeurs de sous-type (par exemple, <span class="codeph"> AssetSet</span>). </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> Propriétés d’un fichier de modèle. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> xsd:string</span> </td> 
   <td colname="col3">Type de fichier. Voir Types <a href="../../string-constants/c-string-constants/r-asset-types.md#reference-2fe75d230663419d88632d30f1144a10" format="dita" scope="local"></a> de fichier pour connaître les valeurs. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> Propriétés d’un fichier de paramètre prédéfini de visionneuse. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="codeph"> <span class="varname"> lecteurSwfInfo</span></span> </td> 
