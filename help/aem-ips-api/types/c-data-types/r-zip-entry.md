---
description: Une entrée dans un fichier ZIP.
...
Une entrée dans un fichier ZIP.
...
| propriétéSizeComprimé | `xsd:long` | Taille compressée. |
| uncompresséTaille | `xsd:long` | Taille non compressée. |
