...
| boolVal | `xsd:boolean` | Valeur de métadonnées booléennes (pour les champs de type booléen uniquement). |
| longVal | `xsd:long` | Valeur de métadonnées longue (pour les champs entrés uniquement). |
