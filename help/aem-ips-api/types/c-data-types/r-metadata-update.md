...
seo-description: Définit les valeurs de métadonnées d’un fichier spécifique utilisé avec setAssetMetadata. Décrit les modifications que vous souhaitez apporter aux métadonnées.
...
<table id="table_04100BB8ABD84EF68B0A7CE3AD946414"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> Valeur de métadonnées longue (pour les champs à saisie unique). </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="codeph"> <span class="varname"> doubleVal</span></span> </td> 
   <td colname="col2"> <span class="codeph"> xsd:</span> </td> 
   <td colname="col3"> Valeur de métadonnées  (pour les champs de type flottant uniquement). </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Ajoute au de valeurs de balise existant pour le fichier. 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> types:StringArray</span> </td> 
   <td colname="col3">Remplace le de valeurs de balise existant pour le fichier. 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> types:StringArray</span> </td> 
   <td colname="col3"> Supprime les valeurs spécifiées du de valeurs de balise du fichier, le cas échéant. </td> 
  </tr> 
 </tbody> 
</table>
