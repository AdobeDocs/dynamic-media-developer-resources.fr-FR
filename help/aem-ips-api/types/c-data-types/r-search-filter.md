 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3">Définissez sur : 
    <ul id="ul_BD8686943BD14D05A21C00192D4D70D3"> 
     ...
     <li id="li_10A581F98B4847ED8EBE4AECC3AD70A8"><span class="codeph"> False</span>: pour effectuer une recherche uniquement sur le dossier nommé. </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="codeph"> <span class="varname"> assetTypeArray</span> </span> </td> 
   <td colname="col2"> <span class="codeph"> type:StringArray</span> </td> 
   <td colname="col3">Liste des types de ressources que vous souhaitez renvoyer dans une recherche. Par exemple, la variable <span class="codeph"> image</span>. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3">Spécifier: 
    ...
    </ul> <p>Remarque : laissez le champ vide pour rechercher <i>all</i> types d’état publiés. </p> </td> 
  </tr> 
  <tr> 
