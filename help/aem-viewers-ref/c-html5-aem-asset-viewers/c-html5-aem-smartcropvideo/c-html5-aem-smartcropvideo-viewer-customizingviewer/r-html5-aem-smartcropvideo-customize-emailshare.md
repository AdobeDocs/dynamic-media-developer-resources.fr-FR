...
Le recouvrement d’arrière-plan qui couvre une page web lorsque la boîte de dialogue est active est contrôlé par le sélecteur de classe CSS suivant :
...
Exemple - Pour configurer un en-tête de boîte de dialogue avec marge intérieure, icône de 24 x 17 pixels et titre en gras de 16 points. Enfin, un bouton Fermer de 28 x 28 pixels, positionné à deux pixels du haut et à deux pixels de la droite du conteneur de boîte de dialogue :
...
Exemple - Pour configurer un pied de boîte de dialogue avec un bouton Annuler 64 x 34 et un bouton Envoyer un e-mail 82 x 34. Enfin, la couleur du texte et la couleur d’arrière-plan sont différentes pour chaque état de bouton :
...
Les libellés de la boîte de dialogue peuvent être localisés. Voir [Localisation des éléments de l’interface utilisateur](../../../c-html5-aem-asset-viewers/c-html5-aem-smartcropvideo/r-html5-aem-smartcropvideo-viewer-localization.md#concept-1d5ca2d8480f4064a51eddba13940aad) pour plus d’informations.
...
Le champ de saisie « À » est plus étroit, car il alloue de l’espace pour le bouton « Supprimer l’e-mail » sur la droite. Il est contrôlé avec le sélecteur de classe CSS suivant :
...
Exemple - Pour configurer un formulaire avec une bordure grise d’un pixel avec neuf pixels de marge intérieure autour de tous les champs de saisie. Pour avoir la même bordure en rouge pour les champs qui n’ont pas été validés, pour avoir un champ d’entrée « À » de 250 pixels de large et le reste des champs d’entrée d’une largeur de 300 pixels :
...
Le bouton « Ajouter une autre adresse e-mail » permet à l’utilisateur d’ajouter plusieurs adresses dans un formulaire d’e-mail. Il est contrôlé avec le sélecteur de classe CSS suivant :
...
Le contenu partagé est affiché au bas du corps de la boîte de dialogue et comprend une miniature, un titre, une URL d’origine et une description. Il est emballé dans un conteneur contrôlé par :
...
Exemple - Pour configurer un message afin d’utiliser une police en gras de dix points, utilisez une hauteur de ligne de 25 pixels et une marge intérieure de 20 pixels sur la gauche. Utilisez également une icône de point d’exclamation, du texte rouge en cas d’erreur et aucune icône et du texte vert en cas de succès :
