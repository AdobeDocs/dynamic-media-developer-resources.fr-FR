...
>
>Le sélecteur d’attributs `replay='true'` est défini lorsque la vidéo a atteint sa fin et que vous sélectionnez le bouton pour relancer la lecture depuis le début.
...
Pour configurer un bouton Lecture/Pause de 32 x 32 pixels. Placez-le à six pixels des bords supérieur et gauche de la barre de contrôle. Enfin, affichez une image différente pour chacun des quatre états de bouton différents, qu’ils soient sélectionnés ou non.
