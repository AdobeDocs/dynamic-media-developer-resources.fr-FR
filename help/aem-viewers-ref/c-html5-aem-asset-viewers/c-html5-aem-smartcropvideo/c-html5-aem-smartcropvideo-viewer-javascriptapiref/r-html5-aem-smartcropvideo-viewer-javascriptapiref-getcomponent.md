...
Lorsque vous utilisez des API SDK, il est important d’utiliser l’espace de noms SDK complet correct, comme décrit dans la section [Espace de noms du SDK de la visionneuse]
