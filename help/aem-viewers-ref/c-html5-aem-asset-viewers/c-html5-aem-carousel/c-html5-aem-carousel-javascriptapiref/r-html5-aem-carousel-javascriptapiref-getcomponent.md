...
Lorsque vous utilisez des API SDK, il est important d’utiliser l’espace de noms du SDK complet correct, comme décrit dans la section [Espace de noms du SDK de la visionneuse](../../../c-html5-aem-asset-viewers/c-html5-aem-carousel/c-html5-aem-carousel-namespace.md).
