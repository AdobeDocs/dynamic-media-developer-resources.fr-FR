...
<table id="table_7B5DD9303EF44ADD847B13FFEAD135D9"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> </span> carouselView <span class="codeph"> </p> </td> 
...
Lorsque vous utilisez les API SDK, il est important d’utiliser l’espace de noms SDK complet approprié, comme décrit dans la section [Espace de noms SDK de la visionneuse](../../../c-html5-aem-asset-viewers/c-html5-aem-carousel/c-html5-aem-carousel-namespace.md).
