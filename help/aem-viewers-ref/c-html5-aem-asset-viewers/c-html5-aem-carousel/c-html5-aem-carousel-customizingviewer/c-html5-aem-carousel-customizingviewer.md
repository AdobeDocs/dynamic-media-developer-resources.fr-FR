---
description: La personnalisation visuelle et la personnalisation du comportement la plus fréquente pour la visionneuse de carrousel s’effectuent en créant une page CSS personnalisée.
keywords: responsive
seo-description: La personnalisation visuelle et la personnalisation du comportement la plus fréquente pour la visionneuse de carrousel s’effectuent en créant une page CSS personnalisée.
...
La personnalisation visuelle et la personnalisation du comportement la plus fréquente pour la visionneuse de carrousel s’effectuent en créant une page CSS personnalisée.
...
Lors de la création d’une page CSS personnalisée, gardez à l’esprit que le lecteur affecte `.s7carouselviewer` une classe à son élément DOM . Si vous utilisez un fichier CSS externe transmis avec la `style=` commande, utilisez `.s7carouselviewer` class comme classe parent dans le sélecteur descendant pour vos règles CSS. Si vous ajoutez des styles incorporés à la page Web, qualifiez en outre ce sélecteur avec un ID de l’élément DOM  comme suit :
...
Voici un exemple de style basé sur une image-objet :
