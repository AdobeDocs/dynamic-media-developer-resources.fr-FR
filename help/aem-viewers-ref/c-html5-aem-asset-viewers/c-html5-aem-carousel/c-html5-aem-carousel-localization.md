...
description: Certains contenus affichés par la visionneuse de carrousel sont sujets à localisation. Ce contenu comprend des boutons de navigation dans les diapositives.
...
Certains contenus affichés par la visionneuse de carrousel sont sujets à localisation. Ce contenu comprend des boutons de navigation dans les diapositives.
...
<table id="table_58C40353B7244335872350C98DF2CFB3"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>État du bouton de pause de lecture non sélectionné. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> CAROUSELVIEWER_TOOLTIP_GOTO </span> </p> </td> 
   <td colname="col2"> <p> Info-bulle et libellé ARIA pour les boutons de diapositive précédent et suivant. </p> <p>Accepte deux jetons de remplacement : <span class="codeph"> $CURRENT_FRAME$ </span> pour l’index de diapositive actuel et <span class="codeph"> $TOTAL_FRAMES$ </span> pour le nombre total de diapositives. </p> </td> 
  </tr> 
  <tr> 
