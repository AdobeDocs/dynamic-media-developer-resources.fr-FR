...
Le bouton plein écran fait passer le lecteur vidéo en mode plein écran ou le quitte lorsqu’un utilisateur clique dessus.
...
**Exemple** - Pour configurer un bouton plein écran de 32 x 32 pixels et positionné à 6 pixels du bord supérieur et droit de la barre de contrôle. Affichez également une image différente pour chacun des quatre états de bouton différents lorsqu’il est sélectionné ou non.
