...
**Exemple** - Pour configurer un bouton de lecture/pause de 32 x 32 pixels. Positionnez-le à six pixels des bords supérieur et gauche de la barre de contrôle. Enfin, affiche une image différente pour chacun des quatre états de bouton différents, qu’ils soient sélectionnés ou non.
