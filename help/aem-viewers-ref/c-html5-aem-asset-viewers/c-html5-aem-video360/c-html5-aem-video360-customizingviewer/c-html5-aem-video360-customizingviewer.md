...
Lorsqu’elles sont appliquées aux visionneuses mobiles HTML5, elles utilisent quatre requêtes multimédias CSS, définies dans votre CSS, dans l’ordre indiqué ci-dessous :
