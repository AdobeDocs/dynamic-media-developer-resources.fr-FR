...
Lorsque vous utilisez des API SDK, il est important d’utiliser l’espace de noms SDK complet approprié, comme décrit dans la section [Espace de noms SDK de la visionneuse](../../../c-html5-aem-asset-viewers/c-html5-aem-video360/c-html5-aem-video360-viewer-sdk-namespace.md#concept-4ee8657c7d67421f8e7880130a246621).

Consultez la documentation de l’*API HTML5 Viewer SDK* pour plus d’informations sur un composant particulier.

## Renvoie {#section-1d3cf85bc7cc4dfe9670e038d02b9101}

Le `{Object}` est une référence au composant SDK de la visionneuse. La méthode renvoie la valeur `null` si le `componentId` n’est pas un composant de visionneuse pris en charge ou si le composant n’a pas encore été créé par la logique de visionneuse.
