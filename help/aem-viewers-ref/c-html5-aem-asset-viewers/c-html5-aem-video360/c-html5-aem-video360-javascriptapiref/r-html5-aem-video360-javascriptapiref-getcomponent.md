...
Lorsque vous travaillez avec des API SDK, il est important d’utiliser le SDK complet  correctement qualifié, comme décrit dans le SDK du [lecteur de contenu,  le](../../../c-html5-aem-asset-viewers/c-html5-aem-video360/c-html5-aem-video360-viewer-sdk-namespace.md#concept-4ee8657c7d67421f8e7880130a246621)de  de SDK.

Pour plus d’informations sur un composant spécifique, consultez la documentation de l’API *du kit de développement de visionneuse* HTML5.
