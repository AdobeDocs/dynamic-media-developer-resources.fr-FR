...
Selon la méthode de publication [!DNL Dynamic Media] la vidéo que vous utilisez dans Adobe Experience Manager, la `VideoPlayer.ssl` l’attribut configuration est appliqué différemment, comme illustré dans les exemples suivants :
