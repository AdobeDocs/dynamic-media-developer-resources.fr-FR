...
>[!NOTE]
>
>Si les styles d’info-bulle sont personnalisés à partir de la page Web d’incorporation, toutes les propriétés doivent contenir la `!IMPORTANT` règle. Cela n’est pas nécessaire si les info-bulles sont personnalisées dans le fichier CSS du lecteur de contenu.

## Exemple {#section-59e009fd05b14019936aba04d7ca779d}

Pour configurer des info-bulles avec une bordure grise avec un rayon d’angle de trois pixels, un arrière-plan noir et du texte blanc en Arial, 11 pixels :
