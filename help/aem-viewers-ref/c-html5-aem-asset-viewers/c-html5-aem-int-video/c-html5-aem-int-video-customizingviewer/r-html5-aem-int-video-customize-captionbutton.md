...
Pour configurer un bouton de sous-titrage codé de 28 x 28 pixels. Le bouton doit être positionné à quatre pixels du haut et à 68 pixels du bord droit de la barre de contrôle. De plus, il doit afficher une image différente pour chacun des quatre états de bouton différents lorsqu’il est sélectionné ou non.
