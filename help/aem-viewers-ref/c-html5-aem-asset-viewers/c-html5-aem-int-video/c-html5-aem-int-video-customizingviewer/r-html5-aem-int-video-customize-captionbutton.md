...
Pour configurer un bouton de légende de 28 x 28 pixels. Le bouton doit être positionné à quatre pixels du haut et à 68 pixels du bord droit de la barre de contrôle. De plus, elle doit afficher une image différente pour chacun des quatre états de bouton différents, qu’ils soient sélectionnés ou non.
