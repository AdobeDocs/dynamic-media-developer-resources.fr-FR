...
Lorsque vous travaillez avec des API SDK, il est important d’utiliser le de SDK  qualifié approprié, comme décrit dans le kit SDK de [lecteur de contenu,  le](../../../c-html5-aem-asset-viewers/c-html5-aem-interactive-images/c-html5-aem-interactive-image-namespace.md#concept-00a31b9bc7eb4014b28c1ba661fe5265)SDK.
