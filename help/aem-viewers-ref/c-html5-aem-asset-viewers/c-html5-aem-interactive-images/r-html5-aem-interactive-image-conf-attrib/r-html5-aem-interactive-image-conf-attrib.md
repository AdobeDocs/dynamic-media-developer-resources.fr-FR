...
description: Documentation sur les attributs de configuration pour la visionneuse d’images interactives.
...
Documentation sur les attributs de configuration pour la visionneuse d’images interactives.
...
* `cont_zoomView.fmt` (qualifié avec l’ID de composant, en supposant que `cont` soit l’ID de l’élément de conteneur)
