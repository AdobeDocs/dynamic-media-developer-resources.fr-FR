...
<table id="table_A2A0ACD942E942BC99AF0DC80FB1C670"> 
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> <span class="varname"> image </span> </span> </p> </td> 
   <td colname="col2"> <p> Indique une seule image. Appliquez un codage HTTP double à n’importe quel caractère non sécurisé existant dans le nom de l’image. </p> <p>Vous pouvez également spécifier une référence à une visionneuse d’images. La visionneuse récupère les visionneuses d’images à partir du serveur, à l’aide de la requête <span class="codeph"> req=set IS </span> . </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> <span class="varname"> imageList </span> </span> </p> </td> 
   <td colname="col2"> <p> Indique un jeu d’images explicite, constitué d’une séquence triée d’éléments ou d’images, séparés par des virgules. </p> <p> <p>Remarque : Cette fonctionnalité est prise en charge dans Adobe Dynamic Media Classic ; elle n’est pas prise en charge dans Adobe Experience Manager Assets. </p> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Commandes de diffusion d’images ; <span class="codeph"> &amp; </span> et <span class="codeph"> = </span> Les séparateurs doivent être codés en HTTP sous la forme respectivement de <span class="codeph"> %26 </span> et <span class="codeph"> %3D </span>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
` asset=( *`mediaSet`* | ( *`video`*; *`swatchId`* | *`image`*; *`swatchId`* | *`setId`*; *`swatchId`*); *`ID`*;( *`video`*; *`swatchId`* | *`image`*; *`swatchId`* | *`setId`*; *`swatchId`*); *`ID`*;] [%3F *`modificateurs`*]`
...
<table id="table_D31C8507C02A4452A79DEDDEC62EF2F5"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Une seule vidéo ou visionneuse de vidéos adaptative. </p> <p> <p>Remarque : Cette fonctionnalité est prise en charge dans Adobe Dynamic Media Classic ; elle n’est pas prise en charge dans Adobe Experience Manager Assets. </p> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> <span class="varname"> image </span> </span> </p> </td> 
   <td colname="col2"> <p> Une seule image. </p> <p> <p>Remarque : Cette fonctionnalité est prise en charge dans Adobe Dynamic Media Classic ; elle n’est pas prise en charge dans Adobe Experience Manager Assets. </p> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Image de l’échantillon. </p> <p> <p>Remarque : Cette fonctionnalité est prise en charge dans Adobe Dynamic Media Classic ; elle n’est pas prise en charge dans Adobe Experience Manager Assets. </p> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> L’identifiant de type d’élément de la visionneuse de médias peut être l’un des suivants : </p> <p> 
     ...
     </ul> </p> <p> <p>Remarque : Cette fonctionnalité est prise en charge dans Adobe Dynamic Media Classic ; elle n’est pas prise en charge dans Adobe Experience Manager Assets. </p> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> <span class="varname"> modificateurs </span> </span> </p> </td> 
   <td colname="col2"> <p> Commandes de diffusion d’images ; <span class="codeph"> &amp; </span> et <span class="codeph"> = </span> Les séparateurs doivent être codés en HTTP sous la forme respectivement de <span class="codeph"> %26 </span> et <span class="codeph"> %3D </span>. </p> </td> 
