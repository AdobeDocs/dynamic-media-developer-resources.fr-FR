...
* Définissez le lecteur vidéo sur `playback=native` mode . Cela permet de lire la vidéo MP4 progressivement.
...
* Les sous-titres vidéo nécessitent un jeu de règles de l’entreprise s’ils hébergent une page de HTML diffusée à partir d’un serveur externe qui n’est pas un serveur Dynamic Media. Contactez l’assistance technique d’Adobe pour obtenir de l’aide.
