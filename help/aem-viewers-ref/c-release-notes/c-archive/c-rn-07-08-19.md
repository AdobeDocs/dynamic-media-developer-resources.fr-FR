...
* Ajout de la prise en charge de l’intégration à Adobe Launch [!DNL Dynamic Media] Extension Visionneuses.
* Ajout de la prise en charge du mode de fonctionnement VR dans le navigateur Oculus pour la visionneuse Video360R.
* Ajout `RolloverKeyEvent.HREF_ACTIVATED` pour permettre au code client de répondre à l’activation de la zone cliquable dans eCatalogViewer et eCatalogSearchViewer.
