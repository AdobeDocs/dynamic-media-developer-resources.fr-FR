...
* Prise en charge Ajoutée de l’intégration avec l’extension Adobe Launch Dynamic Media Viewers.
* Prise en charge Ajoutée du mode de fonctionnement VR dans Oculus Browser for Video360Viewer.
* Ajouté `RolloverKeyEvent.HREF_ACTIVATED` événement permettant au code client de répondre à l’activation de zone cliquable dans eCatalogViewer et eCatalogSearchViewer.
