...
* Ajout de la prise en charge de l’entrée de souris et tactile s’exécutant sous le navigateur Chrome. Les appareils Microsoft Surface font partie de cette catégorie. Toutefois, Microsoft Edge ne fonctionne pas avec l’entrée tactile avec les visionneuses 5.5.
...
* L’image d’affiche peut rencontrer une `max size` erreur. Vous devrez peut-être augmenter le paramètre de limite pour la publication sur hébergeur d’images.
