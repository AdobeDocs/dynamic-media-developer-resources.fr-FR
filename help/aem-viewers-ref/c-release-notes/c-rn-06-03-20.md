...
seo-title: Notes de mise à jour des visionneuses (5.14.1)
solution: Experience Manager
title: Notes de mise à jour des visionneuses (5.14.1)
topic: Dynamic media
...
* Visionneuse de dimensions pour la prévisualisation et la diffusion 3D.
* Amélioration du recadrage de vidéo dynamique dans SmartCropVideoViewer lors de l’exécution en mode intégré.
* Prise en charge Ajoutée des écrans haute résolution pour FlyoutViewer, ZoomVerticalViewer et MixedMediaViewer (lors de l’utilisation du zoom intégré).
