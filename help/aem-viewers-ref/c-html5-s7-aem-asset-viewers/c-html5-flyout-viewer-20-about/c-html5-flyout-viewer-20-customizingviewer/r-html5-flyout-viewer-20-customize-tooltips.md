...
>[!NOTE]
>
>Si les styles d’info-bulle sont personnalisés dans la page web d’intégration, toutes les propriétés doivent contenir la règle `!IMPORTANT`. Toutefois, il n’est pas nécessaire que les info-bulles soient personnalisées dans le fichier CSS de la visionneuse.
