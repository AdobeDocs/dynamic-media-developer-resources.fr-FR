...
>[!NOTE]
>
>Dans le cas où les styles d’info-bulle sont personnalisés à partir de la page Web d’incorporation, toutes les propriétés doivent contenir `!IMPORTANT` une règle. Cependant, il n’est pas nécessaire que les info-bulles soient personnalisées dans le fichier CSS de la visionneuse.
