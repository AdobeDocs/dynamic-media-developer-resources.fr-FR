...
<table id="table_FC34B37AACFB4E92A37E1D2D93D5F0D2"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> </p> <p> Indique le type d’effet appliqué à la vue principale lors du changement de ressource. </p> <p><span class="codeph"> none</span> signifie pas de transition, le changement de vue principal se produit instantanément. </p> <p><span class="codeph"> fade</span> active une transition entre les fondus lorsque l’ancienne image s’estompe et que la nouvelle image s’estompe </p> <p> </p> </td> 
  </tr> 
  <tr> 
