...
>[!NOTE]
>
>Si les styles d’info-bulle sont personnalisés à partir de la page web d’incorporation, toutes les propriétés doivent contenir `!IMPORTANT` règle. Toutefois, il n’est pas nécessaire si les infobulles sont personnalisées dans le fichier CSS de la visionneuse.
