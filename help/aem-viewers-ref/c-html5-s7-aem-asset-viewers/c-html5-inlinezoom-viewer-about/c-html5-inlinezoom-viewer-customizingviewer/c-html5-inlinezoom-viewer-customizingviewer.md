...
Il est également important de conserver la déclaration CSS suivante dans le fichier CSS de la visionneuse par défaut, car elle est nécessaire pour la fonctionnalité de zoom en ligne :
