...
Lorsque vous utilisez des API SDK, il est important d’utiliser correctement un espace de noms SDK complet, comme décrit dans [Kit SDK](../../../c-html5-s7-aem-asset-viewers/c-html5-inlinezoom-viewer-about/c-html5-inlinezoom-viewer-namespace.md#concept-5af3b472b320496d87735ea612edda80) de visionneuse.

Reportez-vous à la documentation du Kit de développement logiciel (SDK) de la visionneuse pour plus d’informations sur un composant particulier.
