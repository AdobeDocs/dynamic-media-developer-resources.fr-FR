...
description: Certains contenus affichés par la visionneuse à 360° sont sujets à localisation, notamment les boutons de zoom et un bouton plein écran.
...
Certains contenus affichés par la visionneuse à 360° sont sujets à localisation, notamment les boutons de zoom et un bouton plein écran.
...
Le code de la page Web doit transmettre l’objet de localisation au constructeur de la visionneuse, en tant que valeur de champ de `localizedTexts` l’objet de configuration. Une autre option consiste à transmettre l’objet de localisation en appelant la méthode `setLocalizedTexts(localizationInfo)` .
...
<table id="table_58C40353B7244335872350C98DF2CFB3"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Bouton de rotation vers la gauche. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> PanRightButton.TOOLTIP </span> </p> </td> 
   <td colname="col2"> <p>Bouton de rotation vers la droite. </p> </td> 
  </tr> 
 </tbody> 
</table>
