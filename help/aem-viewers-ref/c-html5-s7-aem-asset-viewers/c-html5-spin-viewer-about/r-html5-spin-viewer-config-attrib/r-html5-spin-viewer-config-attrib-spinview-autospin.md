...
<table id="table_49FFD1BC53B846F09A6D214BC8C5C3FE"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> Active ou désactive l’animation de rotation automatique. Pour obtenir la meilleure expérience de rotation automatique, il est recommandé de précharger toutes les images en définissant <span class="codeph"> maxloadradius</span> sur <span class="codeph"> -1</span>. Notez toutefois que ce paramètre entraîne une augmentation du temps de chargement et de l’utilisation de la bande passante. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Nombre de rotations complètes effectuées avant l’arrêt de l’autospin. Le nombre est un nombre à virgule flottante. Définissez ce paramètre sur <span class="codeph"> -1</span> pour une rotation automatique infinie. </p> </td> 
  </tr> 
 </tbody> 
</table>
