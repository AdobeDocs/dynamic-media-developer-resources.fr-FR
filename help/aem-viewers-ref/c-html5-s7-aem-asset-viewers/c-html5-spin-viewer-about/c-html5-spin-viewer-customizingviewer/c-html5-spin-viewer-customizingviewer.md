---
description: La personnalisation visuelle et la personnalisation du comportement la plus fréquente pour la visionneuse à 360° se font en créant une page CSS personnalisée.
keywords: responsive
seo-description: La personnalisation visuelle et la personnalisation du comportement la plus fréquente pour la visionneuse à 360° se font en créant une page CSS personnalisée.
...
La personnalisation visuelle et la personnalisation du comportement la plus fréquente pour la visionneuse à 360° se font en créant une page CSS personnalisée.
...
Le lecteur est fourni avec des fichiers CSS prêts à l’emploi, pour les modèles de couleurs &quot;clair&quot; et &quot;foncé&quot;. La version &quot;light&quot; est utilisée par défaut, mais vous pouvez passer à la version &quot;dark&quot; à l’aide de la page CSS standard suivante :
...
Lors de la création d’une page CSS personnalisée, gardez à l’esprit que le lecteur affecte `.s7spinviewer` une classe à son élément DOM . Si vous utilisez un fichier CSS externe transmis avec `style=` la commande, utilisez `.s7spinviewer` class comme classe parent dans le sélecteur descendant pour vos règles CSS. Si vous créez des styles intégrés sur la page Web, qualifiez en outre ce sélecteur avec l’ID de l’élément DOM  comme suit :
