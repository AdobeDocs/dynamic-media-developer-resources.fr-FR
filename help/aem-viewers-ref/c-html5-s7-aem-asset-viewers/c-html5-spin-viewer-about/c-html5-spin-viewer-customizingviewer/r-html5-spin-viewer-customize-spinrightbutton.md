...
Exemple : pour configurer un bouton de droite à 360° de 28 x 28 pixels et situé sur le bord droit du conteneur intérieur. Enfin, affiche une image différente pour chacun des quatre états de bouton différents :
