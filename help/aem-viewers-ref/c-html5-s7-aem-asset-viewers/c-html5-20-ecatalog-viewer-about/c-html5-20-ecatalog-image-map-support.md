...
La sélection d’une zone cliquable effectue un échange de page interne dans la visionneuse. Pour utiliser cette fonctionnalité, un attribut `href` dans la zone cliquable possède le format spécial suivant :
