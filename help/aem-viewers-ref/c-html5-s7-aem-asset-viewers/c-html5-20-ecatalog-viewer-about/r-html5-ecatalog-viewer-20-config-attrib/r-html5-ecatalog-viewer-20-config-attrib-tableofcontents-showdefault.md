...
<table id="table_BE34F807437C4955A2A640495E05138F"> 
 <tbody> 
  <tr> 
   ...
   <td> <p> Lorsqu’il est défini sur <span class="codeph"> 1</span>, le composant remplit le panneau déroulant avec des éléments pour toutes les pages, même pour les pages dont le libellé n’est pas défini. </p> <p>Lorsque la valeur est définie sur <span class="codeph"> 0</span> seuls les éléments dotés de libellés explicites s’affichent dans le panneau déroulant. </p> </td> 
  </tr> 
 </tbody> 
</table>
