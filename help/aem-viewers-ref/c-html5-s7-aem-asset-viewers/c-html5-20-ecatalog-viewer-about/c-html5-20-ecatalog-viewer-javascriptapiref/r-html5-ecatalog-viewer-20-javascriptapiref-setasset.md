...
Définit une nouvelle ressource. Vous pouvez appeler ce paramètre à tout moment, avant ou après `init()`. Si elle est appelée après `init()`, la visionneuse échange la ressource au moment de l’exécution.
