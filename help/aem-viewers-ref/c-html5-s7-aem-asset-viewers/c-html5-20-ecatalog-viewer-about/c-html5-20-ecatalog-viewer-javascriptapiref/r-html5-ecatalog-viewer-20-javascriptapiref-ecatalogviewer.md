...
seo-title: Visionneuse de catalogue électronique
solution: Experience Manager
title: Visionneuse de catalogue électronique
topic: Dynamic media
...
# Visionneuse de catalogue électronique{#ecatalogviewer}

Référence de l’API JavaScript pour la visionneuse de catalogue électronique.

`eCatalogViewer([config])`

Constructeur, crée une nouvelle instance de visionneuse de catalogue électronique.
