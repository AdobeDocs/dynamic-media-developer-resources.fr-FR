...
Exemple - Pour configurer un bouton de partage de lien qui fait 28 x 28 pixels et affiche une image différente pour chacun des quatre états de bouton différents :
...
Le pied de boîte de dialogue se compose d’un bouton Annuler. Le conteneur de pied de page est contrôlé avec le sélecteur de classe CSS suivant :
