...
Lorsque vous sélectionnez ou appuyez sur ce bouton, l’utilisateur accède à la dernière page du catalogue. Ce bouton s’affiche dans la barre de contrôle principale sur les ordinateurs de bureau et les tablettes ; sur les téléphones mobiles, il est ajouté à une barre de contrôle secondaire. Vous pouvez dimensionner, habiller et positionner ce bouton à l’aide de CSS.
...
Exemple : pour configurer un dernier bouton de page de 28 x 28 pixels et positionné 4 pixels à partir du bas et de 220 pixels à partir du bord gauche de la barre de contrôle principale. Et enfin, affiche une image différente pour chacun des quatre états de bouton différents.
