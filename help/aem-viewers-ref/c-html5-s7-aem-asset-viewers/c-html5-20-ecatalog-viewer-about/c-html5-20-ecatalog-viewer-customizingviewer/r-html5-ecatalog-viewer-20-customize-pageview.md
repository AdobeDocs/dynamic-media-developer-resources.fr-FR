...
Il est possible de configurer l’affichage des curseurs de souris personnalisés sur la zone de visualisation principale. Ceci est contrôlé avec les sélecteurs d’attributs supplémentaires appliqués à la classe `.s7ecatalogviewer .s7pageview` CSS :
