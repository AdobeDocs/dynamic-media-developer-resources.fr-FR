...
description: La table des matières est un bouton positionné dans la barre de contrôle principale. Une fois activé, un panneau déroulant s’affiche avec une liste d’index et de libellés de page.
...
La table des matières est un bouton positionné dans la barre de contrôle principale. Une fois activé, un panneau déroulant s’affiche avec une liste d’index et de libellés de page.
...
Exemple - Pour configurer un bouton de table des matières positionné à 4 pixels du bas et à 43 pixels de la gauche de la barre de contrôle principale. La taille est de 28 x 28 pixels et une image différente s’affiche pour chacun des quatre états de bouton différents :
...
L’aspect de l’élément individuel est contrôlé par le sélecteur de classe CSS suivant :
...
Si le nombre d’éléments pouvant tenir verticalement dans le panneau déroulant est supérieur à et que le système est un bureau, le composant affiche une barre de défilement verticale sur le côté droit du panneau. L’aspect de la zone de la barre de défilement est contrôlé par le sélecteur de classe CSS suivant :
