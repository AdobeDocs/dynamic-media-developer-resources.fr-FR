...
description: L’outil Partage sur les réseaux sociaux s’affiche par défaut dans le coin supérieur gauche. Il se compose d’un bouton et d’un panneau qui se développe lorsque l’utilisateur clique ou appuie sur un bouton et contient des outils de partage individuels.
...
L’outil Partage sur les réseaux sociaux s’affiche par défaut dans le coin supérieur gauche. Il se compose d’un bouton et d’un panneau qui se développe lorsque l’utilisateur clique ou appuie sur un bouton et contient des outils de partage individuels.
...
<table id="table_C48C56E696304C9BAFEE71BA9EA9A174"> 
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> margin=gauche </span> </p> </td> 
...
Exemple - Pour configurer un outil de partage sur les réseaux sociaux positionné à quatre pixels du haut et à cinq pixels à droite du conteneur de la visionneuse et dont la taille est de 28 x 28 pixels :
...
Exemple - Pour configurer un bouton d’outil de partage social qui affiche une image différente pour chacun des quatre états de bouton différents :
