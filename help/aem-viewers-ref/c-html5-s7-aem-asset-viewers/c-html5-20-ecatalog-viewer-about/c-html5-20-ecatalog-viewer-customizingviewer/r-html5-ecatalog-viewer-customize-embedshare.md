...
Exemple - Pour définir la zone de liste déroulante Taille d’incorporation sur une largeur de 300 pixels lors de l’affichage d’un élément prédéfini et sur une largeur de 110 pixels lors de l’affichage d’une taille personnalisée :
...
Exemple - Pour définir la hauteur du texte de la zone de liste déroulante Taille d’incorporation sur 40 pixels :
...
Exemple - Pour définir la taille personnalisée du panneau Champs de saisie sur 20 pixels à droite de la zone de liste modifiable :
