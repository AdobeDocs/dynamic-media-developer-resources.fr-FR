...
S’il y a plus de vignettes que ce qui peut tenir verticalement dans la vue, les vignettes restituent la barre de défilement verticale sur le côté droit. L’apparence de la zone de la barre de défilement est contrôlée par le sélecteur de classe CSS suivant :
