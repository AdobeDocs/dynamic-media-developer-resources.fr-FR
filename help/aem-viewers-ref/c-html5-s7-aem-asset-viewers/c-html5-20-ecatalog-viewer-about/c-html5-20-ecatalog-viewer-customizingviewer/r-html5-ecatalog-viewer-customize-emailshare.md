...
Exemple : pour configurer l’en-tête de la boîte de dialogue avec remplissage, une icône de 24 x 17 pixels, un titre en gras de 16 points et un bouton Fermer de 28 x 28 pixels positionné à deux pixels du haut et à deux pixels de la droite du de la boîte de dialogue :
...
Les info-bulles de ces boutons peuvent être localisées. Pour plus d’informations, voir [des éléments](../../../c-html5-s7-aem-asset-viewers/c-html5-20-ecatalog-viewer-about/c-html5-20-ecatalog-viewer-localization.md#concept-cbfc39344c494eb7b9f6a272cff0cc74) de l’interface utilisateur.
...
La plupart des champs d’entrée qui s’étendent du libellé de gauche au bord droit du corps de la boîte de dialogue (y compris le champ De et le champ Message) sont contrôlés à l’aide du sélecteur de classe CSS suivant :
...
Le champ À est plus étroit, car il alloue de l’espace pour le bouton Supprimer l’e-mail sur la droite. Il est contrôlé par le sélecteur de classe CSS suivant :
...
Exemple : pour configurer un formulaire de sorte qu’il ait une bordure d’un pixel de gris avec neuf pixels de remplissage autour de tous les champs d’entrée ; pour avoir la même bordure en rouge pour les champs dont la validation a échoué, pour avoir un champ de saisie de 250 pixels de large et le reste des champs d’entrée de 300 pixels de large :
...
Ajouter le bouton Autre adresse électronique permet à un utilisateur d’ajouter plusieurs adresses dans un formulaire de courrier électronique. Il est contrôlé par le sélecteur de classe CSS suivant :
...
Le contenu partagé s’affiche dans la partie inférieure du corps de la boîte de dialogue et comprend une miniature, un titre,   URL du et une description. Il est encapsulé dans un  contrôlé par le sélecteur de classe CSS suivant :
