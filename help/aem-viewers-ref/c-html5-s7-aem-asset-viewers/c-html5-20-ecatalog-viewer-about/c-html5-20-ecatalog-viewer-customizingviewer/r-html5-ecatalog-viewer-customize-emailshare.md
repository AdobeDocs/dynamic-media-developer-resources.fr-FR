...
Exemple : pour configurer un formulaire avec une bordure grise d’un pixel avec une marge intérieure de neuf pixels autour de tous les champs de saisie. Pour avoir la même bordure en rouge pour les champs dont la validation a échoué. Pour un champ de 250 pixels de large. Enfin, le reste des champs d’entrée mesure 300 pixels de large :
