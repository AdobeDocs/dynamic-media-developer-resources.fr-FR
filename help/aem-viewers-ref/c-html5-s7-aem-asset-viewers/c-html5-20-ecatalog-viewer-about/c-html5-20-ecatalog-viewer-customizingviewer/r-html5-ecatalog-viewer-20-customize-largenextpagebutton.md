...
# Bouton Grand page suivante{#large-next-page-button}
...
Exemple : pour configurer un bouton de page suivante de grande taille de 56 x 56 pixels, centré verticalement et ancré à la bordure droite du lecteur de contenu, et affiche une image différente pour chacun des quatre états de bouton différents.
