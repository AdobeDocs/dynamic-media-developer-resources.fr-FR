---
title: Bouton Page suivante volumineux
description: Pour accéder à la page suivante du catalogue, cliquez ou appuyez sur ce bouton. Ce bouton apparaît dans la barre de contrôle principale. Ce bouton n'est pas affiché sur les téléphones mobiles pour économiser l'espace de l'écran. Vous pouvez dimensionner, habiller et positionner ce bouton à l’aide de CSS.
...
# Bouton Page suivante volumineux{#large-next-page-button}
...
Exemple : pour configurer un grand bouton de page suivante de 56 x 56 pixels, centré verticalement et ancré à la bordure droite de la visionneuse, et qui affiche une image différente pour chacun des quatre états de bouton différents.
