...
Lorsque vous sélectionnez ou appuyez sur ce bouton, un zoom s’affiche sur une image dans la vue principale. Ce bouton apparaît dans la barre de contrôle principale. Ce bouton n’est pas affiché sur les téléphones mobiles pour économiser de l’espace sur l’écran. Vous pouvez dimensionner, habiller et positionner ce bouton à l’aide de CSS.
...
Exemple : pour configurer un bouton de zoom avant de 28 x 28 pixels et positionné 4 pixels à partir du bas et 103 pixels à partir du bord droit de la barre de contrôle principale. Et enfin, affiche une image différente pour chacun des quatre états de bouton différents.
