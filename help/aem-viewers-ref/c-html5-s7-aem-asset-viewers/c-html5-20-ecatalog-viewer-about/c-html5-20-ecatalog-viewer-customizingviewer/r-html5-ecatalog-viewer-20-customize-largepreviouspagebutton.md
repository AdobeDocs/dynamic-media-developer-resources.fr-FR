...
description: Cliquer ou appuyer sur ce bouton permet à l’utilisateur d’accéder à la page précédente du catalogue. Ce bouton apparaît dans la barre de contrôle principale. Ce bouton n’est pas affiché sur les téléphones mobiles pour économiser de l’espace sur l’écran. Vous pouvez dimensionner, habiller et positionner ce bouton à l’aide de CSS.
...
# Bouton Grande page précédente{#large-previous-page-button}

Lorsque vous sélectionnez ou appuyez sur ce bouton, l’utilisateur accède à la page précédente du catalogue. Ce bouton apparaît dans la barre de contrôle principale. Ce bouton n’est pas affiché sur les téléphones mobiles pour économiser de l’espace sur l’écran. Vous pouvez dimensionner, habiller et positionner ce bouton à l’aide de CSS.
...
Exemple : pour configurer un bouton de page précédente de grande taille de 56 x 56 pixels, centré verticalement et ancré à la bordure de la visionneuse gauche, et qui affiche une image différente pour chacun des quatre états de bouton différents.
