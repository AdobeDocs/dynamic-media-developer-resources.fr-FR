...
seo-description: En cliquant ou en appuyant sur ce bouton, l’utilisateur accède à la page précédente du catalogue. Ce bouton apparaît dans la barre de contrôle principale. Ce bouton n’est pas affiché sur les téléphones mobiles pour enregistrer l’espace sur l’écran. Vous pouvez dimensionner, habiller et positionner ce bouton à l’aide de CSS.
seo-title: Grand bouton de page précédente
solution: Experience Manager
title: Grand bouton de page précédente
topic: Dynamic media
...
# Grand bouton de page précédente{#large-previous-page-button}
...
Exemple : pour configurer un bouton de page précédente de grande taille de 56 x 56 pixels, centré verticalement et ancré à la bordure du lecteur de gauche, et afficher une image différente pour chacun des quatre états de bouton différents.
