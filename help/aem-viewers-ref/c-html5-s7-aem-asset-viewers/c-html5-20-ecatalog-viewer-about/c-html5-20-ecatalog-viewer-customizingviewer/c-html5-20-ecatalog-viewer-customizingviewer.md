---
description: La personnalisation visuelle et la personnalisation du comportement la plus fréquente pour la visionneuse de catalogue électronique s’effectuent en créant une page CSS personnalisée.
keywords: responsive
seo-description: La personnalisation visuelle et la personnalisation du comportement la plus fréquente pour la visionneuse de catalogue électronique s’effectuent en créant une page CSS personnalisée.
...
La personnalisation visuelle et la personnalisation du comportement la plus fréquente pour la visionneuse de catalogue électronique s’effectuent en créant une page CSS personnalisée.
...
Lors de la création d’une page CSS personnalisée, gardez à l’esprit que le lecteur affecte `.s7ecatalogviewer` une classe à son élément DOM . Si vous utilisez un fichier CSS externe transmis avec la `style=` commande, utilisez `.s7ecatalogviewer` class comme classe parent dans le sélecteur descendant pour vos règles CSS. Si vous créez des styles intégrés sur la page Web, qualifiez en outre ce sélecteur avec l’ID de l’élément DOM  comme suit :
...
Voici la documentation de référence des éléments de l’interface utilisateur qui s’applique à la visionneuse de catalogue électronique :
