...
description: Toutes les personnalisations visuelles et la plupart des personnalisations comportementales de la visionneuse de catalogue électronique sont effectuées en créant un CSS personnalisé.
keywords: réactif
...
Toutes les personnalisations visuelles et la plupart des personnalisations comportementales de la visionneuse de catalogue électronique sont effectuées en créant un CSS personnalisé.
...
Pour faciliter la création d’une feuille de style CSS en responsive design, la visionneuse prend en charge les marqueurs CSS. Des classes CSS spéciales sont affectées dynamiquement à l’élément de conteneur de visionneuse de niveau supérieur en fonction de la taille de la visionneuse au moment de l’exécution et du type d’entrée utilisé sur l’appareil actuel.
...
L’utilisation de marqueurs CSS est le moyen le plus flexible de créer un CSS réactif conçu. Il vous permet de cibler non seulement la taille de l’écran de l’appareil, mais aussi la taille réelle de la visionneuse, ce qui peut s’avérer utile pour les mises en page conçues en responsive design.
