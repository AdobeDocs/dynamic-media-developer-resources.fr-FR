...
La visionneuse de catalogue électronique prend en charge [!DNL Adobe Analytics] suivi d’usine. Pour activer le suivi, transmettez le nom de paramètre prédéfini d’entreprise approprié en tant que `config2` .
