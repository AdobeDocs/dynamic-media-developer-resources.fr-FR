...
<table id="table_0BEA0B5FFDF64E5594B534B2A87A6D88"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Si vous utilisez le paramètre de limite, le composant n’active la haute densité de pixels que jusqu’à la limite spécifiée. </p> <p>Voir l’exemple 2 ci-dessous. </p> </td> 
  </tr> 
 </tbody> 
</table>
