...
Sélectionnez ce bouton pour fermer la page Web contenante. Ce bouton n&#39;apparaît que si le paramètre closebutton est défini sur 1. Vous pouvez dimensionner, habiller et positionner ce bouton à l’aide de CSS.
...
Exemple - Pour configurer un bouton de fermeture de 32 x 32 pixels positionné à six pixels du bord supérieur et droit de la visionneuse. Enfin, affiche une image différente pour chacun des quatre états de bouton différents.
