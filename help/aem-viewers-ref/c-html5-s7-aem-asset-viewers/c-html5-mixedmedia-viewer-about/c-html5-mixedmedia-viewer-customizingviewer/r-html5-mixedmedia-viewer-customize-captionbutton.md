...
seo-description: Active et désactive l’affichage de la légende fermée. Elle n’est pas visible si le paramètre de légende n’est pas spécifié. Vous pouvez utiliser CSS pour dimensionner, habiller et positionner ce bouton par rapport à la barre de contrôle qui le contient.
...
Exemple : pour configurer un bouton de sous-titrage de 28 x 28 pixels, positionner quatre pixels du haut et 68 pixels du bord droit de la barre de contrôle, et afficher une image différente pour chacun des quatre états de bouton lorsqu’il est sélectionné ou non.
