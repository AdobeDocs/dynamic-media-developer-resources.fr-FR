...
description: Active et désactive l’affichage du sous-titre. Elle n’est pas visible si le paramètre de légende n’est pas spécifié. Vous pouvez utiliser CSS pour dimensionner, habiller et positionner ce bouton par rapport à la barre de contrôle qui le contient.
