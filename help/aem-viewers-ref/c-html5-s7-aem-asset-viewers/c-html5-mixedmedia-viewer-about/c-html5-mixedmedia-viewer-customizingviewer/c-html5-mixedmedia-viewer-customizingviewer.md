...
description: Toutes les personnalisations visuelles et la plupart des personnalisations de comportement pour la visionneuse de médias mixtes sont effectuées par la création d’une page CSS personnalisée.
keywords: responsive
...
Toutes les personnalisations visuelles et la plupart des personnalisations de comportement pour la visionneuse de médias mixtes sont effectuées par la création d’une page CSS personnalisée.
...
Pour vous aider à créer une page CSS réactive, la visionneuse prend en charge les marqueurs CSS qui sont des classes CSS spéciales dynamiquement affectées à l’élément de conteneur de la visionneuse de niveau supérieur. Il le fait en fonction de la taille de la visionneuse au moment de l’exécution et du type d’entrée utilisé sur l’appareil actuel.
