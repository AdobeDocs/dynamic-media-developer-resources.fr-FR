...
Exemple : pour configurer un bouton de gauche à 360° de 28 x 28 pixels et qui est positionné sur le bord gauche du conteneur intérieur. Enfin, affiche une image différente pour chacun des quatre états de bouton différents :
