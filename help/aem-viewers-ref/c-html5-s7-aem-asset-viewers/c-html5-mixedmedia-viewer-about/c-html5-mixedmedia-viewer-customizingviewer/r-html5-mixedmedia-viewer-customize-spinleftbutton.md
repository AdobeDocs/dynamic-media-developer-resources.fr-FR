---
description: Cliquez ou appuyez sur ce bouton pour faire tourner l’image vers la gauche dans le  principal. Ce bouton n’est pas affiché sur les téléphones mobiles pour enregistrer l’espace sur l’écran. En outre, le bouton est masqué lorsqu’une visionneuse à 360° multidimensionnelle est utilisée. Vous pouvez dimensionner, habiller et positionner le bouton à l’aide de CSS.
seo-description: Cliquez ou appuyez sur ce bouton pour faire tourner l’image vers la gauche dans le  principal. Ce bouton n’est pas affiché sur les téléphones mobiles pour enregistrer l’espace sur l’écran. En outre, le bouton est masqué lorsqu’une visionneuse à 360° multidimensionnelle est utilisée. Vous pouvez dimensionner, habiller et positionner le bouton à l’aide de CSS.
seo-title: Bouton tournant à gauche
solution: Experience Manager
title: Bouton tournant à gauche
topic: Dynamic media
...
Cliquez ou appuyez sur ce bouton pour faire tourner l’image vers la gauche dans le  principal. Ce bouton n’est pas affiché sur les téléphones mobiles pour enregistrer l’espace sur l’écran. En outre, le bouton est masqué lorsqu’une visionneuse à 360° multidimensionnelle est utilisée. Vous pouvez dimensionner, habiller et positionner le bouton à l’aide de CSS.
...
Exemple : pour configurer un bouton de rotation gauche de 28 x 28 pixels, positionné sur le bord gauche de l’ interne et affichant une image différente pour chacun des quatre états de bouton différents :
