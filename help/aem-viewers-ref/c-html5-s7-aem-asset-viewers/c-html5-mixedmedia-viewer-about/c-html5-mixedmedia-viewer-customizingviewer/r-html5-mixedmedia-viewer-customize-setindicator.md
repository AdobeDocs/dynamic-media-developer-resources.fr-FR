...
description: Définir l’indicateur est une série de points rendus sur les échantillons principaux lorsqu’une visionneuse est utilisée sur un appareil tactile. Les points aident les utilisateurs à parcourir les pages de miniatures lorsque les boutons de défilement ne sont pas disponibles.
...
Exemple - Pour créer un point indicateur défini de 15 x 15 pixels, avec une marge horizontale de deux pixels, une marge supérieure de cinq pixels, une marge inférieure d’un pixel, un rayon de 12 pixels, une couleur par défaut #D5D3D3 et #939393 couleur active :
