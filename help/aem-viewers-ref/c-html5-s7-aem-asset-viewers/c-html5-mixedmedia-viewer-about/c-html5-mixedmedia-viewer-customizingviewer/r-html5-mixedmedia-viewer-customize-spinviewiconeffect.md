---
title: Icône d’affichage à 360°, effet
description: L’indicateur de rotation est superposé sur la zone d’affichage de rotation. Il s’affiche lorsque l’image est dans un état réinitialisé et dépend également du paramètre iconeffect.
...
# Icône d’affichage à 360°, effet{#spin-view-icon-effect}

L’indicateur de rotation est superposé sur la zone d’affichage de rotation. Il s’affiche lorsque l’image est dans un état réinitialisé et dépend également du paramètre iconeffect.
...
L’indicateur de rotation prend en charge le sélecteur d’attributs de `state`, qui est défini sur `spin_1D` s’il existe une visionneuse à 360° unidimensionnelle et sur `spin_2D` s’il existe une visionneuse à 360° multidimensionnelle.
