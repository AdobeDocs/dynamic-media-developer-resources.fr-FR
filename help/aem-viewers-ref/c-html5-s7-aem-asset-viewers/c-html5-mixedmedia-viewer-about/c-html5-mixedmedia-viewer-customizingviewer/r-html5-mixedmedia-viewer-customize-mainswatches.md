...
Le type de fichier s’affiche sous la forme d’une icône superposée au-dessus de l’image miniature et est contrôlé par le sélecteur de classe CSS suivant :
