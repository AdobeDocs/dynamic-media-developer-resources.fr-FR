...
Si, par exemple, vous prévoyez d’écouter les  de l’et que le lecteur est diffusé à partir de Scene7 Publishing System, le  de complet est `StatusEvent.NOTF_VIEW_READY` , et le code de l’écouteur de l’ `s7classic.s7sdk.event.StatusEvent.NOTF_VIEW_READY`de l’ressemble à ce qui suit :
