...
description: Toutes les personnalisations visuelles et la plupart des personnalisations comportementales de la visionneuse de recherche de catalogue électronique sont effectuées en créant un fichier CSS personnalisé.
keywords: réactif
...
Toutes les personnalisations visuelles et la plupart des personnalisations comportementales de la visionneuse de recherche de catalogue électronique sont effectuées en créant un fichier CSS personnalisé.
...
Lors de la création d’un CSS personnalisé, gardez à l’esprit que la visionneuse attribue `.s7ecatalogsearchviewer` classe à son élément DOM conteneur. Si vous utilisez un fichier CSS externe transmis avec la commande `style=`, utilisez `.s7ecatalogsearchviewer` classe comme classe parente dans le sélecteur descendant pour vos règles CSS. Si vous effectuez des styles incorporés sur la page web, vous devez également qualifier ce sélecteur avec un identifiant de l’élément DOM du conteneur comme suit :

`#<containerId>.s7ecatalogsearchviewer`

## Création d’un CSS en responsive design {#section-c1e74f5114ad418884ca1c95f5ea5b63}

Il est possible de cibler différents appareils et tailles d’incorporation dans le CSS pour faire en sorte que votre contenu s’affiche différemment, selon l’appareil d’un utilisateur ou d’une utilisatrice ou une mise en page web particulière. Ce ciblage inclut, sans s’y limiter, différentes dispositions de page web, tailles d’élément de l’interface utilisateur et résolution de l’illustration.
...
Pour créer une feuille de style CSS réactive, la visionneuse prend en charge les marqueurs CSS qui des classes CSS spéciales sont affectées dynamiquement à l’élément de conteneur de la visionneuse de niveau supérieur en fonction de la taille de la visionneuse au moment de l’exécution et du type d’entrée sur l’appareil actuel.

Le premier groupe de marqueurs CSS comprend les classes `.s7size_large`, `.s7size_medium` et `.s7size_small`. Elles sont appliquées en fonction de la zone d’exécution du conteneur de la visionneuse. En d’autres termes, si la zone de la visionneuse est égale ou supérieure à la taille d’un moniteur de bureau commun `.s7size_large` est utilisé, et si la zone est proche de la taille d’une tablette commune, `.s7size_medium` est attribué. Pour les zones similaires aux écrans de téléphone mobile. Le marqueur `.s7size_small` est défini. L’objectif principal de ces marqueurs CSS est de créer différentes dispositions d’interface utilisateur pour différents écrans et tailles de visionneuse.
...
L’exemple de CSS suivant définit la taille du bouton de zoom avant sur 28 x 28 pixels sur les systèmes dotés d’une entrée de souris et 56 x 56 pixels sur les appareils tactiles. En outre, il masque complètement le bouton si la taille de la visionneuse devient trop petite :
...
L’utilisation de marqueurs CSS est le moyen le plus flexible de créer un CSS réactif conçu. Il vous permet de cibler non seulement la taille de l’écran de l’appareil, mais aussi la taille réelle de la visionneuse, ce qui est utile pour les mises en page conçues en responsive design.
...
* [Partage d’e-mail](r-html5-ecatsearch-customize-emailshare.md)
* [Incorporer le partage](r-html5-ecatsearch-customize-embedshare.md)
* [Partager sur Facebook](r-html5-ecatsearch-customize-facebookshare.md)
...
* [Mettre en surbrillance](r-html5-ecatsearch-customize-focushighlight.md)
...
* [Effet de carte graphique](r-html5-ecatsearch-customize-imagemapeffect.md)
* [Bouton Page suivante volumineux](r-html5-ecatsearch-customize-largenextpagebutton.md)
* [Grand bouton de la page précédente](r-html5-ecatsearch-customize-largepreviouspagebutton.md)
* [Bouton Dernière page](r-html5-ecatsearch-customize-lastpagebutton.md)
* [Partage de lien](r-html5-ecatsearch-customize-linkshare.md)
