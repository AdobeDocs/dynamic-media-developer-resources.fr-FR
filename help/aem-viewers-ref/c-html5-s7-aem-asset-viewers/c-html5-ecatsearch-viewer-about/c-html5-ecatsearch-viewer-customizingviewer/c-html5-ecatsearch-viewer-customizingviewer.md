---
description: La personnalisation visuelle et la personnalisation comportementale la plus importante pour la visionneuse de recherche de catalogue électronique s’effectuent en créant une page CSS personnalisée.
keywords: responsive
seo-description: La personnalisation visuelle et la personnalisation comportementale la plus importante pour la visionneuse de recherche de catalogue électronique s’effectuent en créant une page CSS personnalisée.
...
La personnalisation visuelle et la personnalisation comportementale la plus importante pour la visionneuse de recherche de catalogue électronique s’effectuent en créant une page CSS personnalisée.
...
Lors de la création d’une page CSS personnalisée, gardez à l’esprit que le lecteur affecte une classe `.s7ecatalogsearchviewer` à son élément DOM conteneur. Si vous utilisez un fichier CSS externe transmis avec la commande `style=`, utilisez la classe `.s7ecatalogsearchviewer` en tant que classe parent dans le sélecteur descendant pour vos règles CSS. Si vous faites des styles incorporés sur la page Web, qualifiez en outre ce sélecteur avec l’identifiant de l’élément DOM du conteneur comme suit :
...
L’utilisation de marqueurs CSS est la méthode la plus souple de création de pages CSS adaptées, car elle vous permet de cible non seulement la taille de l’écran du périphérique, mais également la taille réelle du lecteur, ce qui peut s’avérer utile pour les mises en page adaptées.
...
Voici la documentation de référence sur les éléments de l’interface utilisateur qui s’applique au lecteur de recherche de catalogue électronique :

* [Bouton Ajouter favori](r-html5-ecatsearch-customize-addfavorite.md)
...
* [Mise en évidence](r-html5-ecatsearch-customize-focushighlight.md)
...
* [Vue de page](r-html5-ecatsearch-customize-pageview.md)
...
* [Bouton vue tous les favoris](r-html5-ecatsearch-customize-viewallfavorites.md)
...
* [Bouton de réinitialisation de zoom](r-html5-ecatsearch-customize-zoomresetbutton.md)
