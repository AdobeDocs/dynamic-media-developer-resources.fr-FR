...
>[!NOTE]
>
>Si les styles d’info-bulle sont personnalisés à partir de la page web d’incorporation, toutes les propriétés doivent contenir `!IMPORTANT` règle. Cette règle n’est pas nécessaire si des info-bulles sont personnalisées dans le fichier CSS de la visionneuse.

Exemple - Pour configurer des info-bulles dont la bordure grise présente un rayon d’angle de 3 px, un arrière-plan noir et un texte blanc écrit en Arial®, taille de 11 pixels :
