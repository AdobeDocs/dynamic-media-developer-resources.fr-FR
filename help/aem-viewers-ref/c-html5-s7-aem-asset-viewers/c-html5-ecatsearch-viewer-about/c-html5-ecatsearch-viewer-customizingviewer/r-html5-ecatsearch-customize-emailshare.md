...
Exemple - Pour configurer un formulaire avec une bordure grise d’un pixel avec neuf pixels de marge intérieure autour de tous les champs de saisie. Avoir la même bordure en rouge pour les champs dont la validation a échoué. Enfin, pour avoir une largeur de champ To de 250 pixels et une largeur de champ de 300 pixels pour le reste des champs d’entrée :
...
Lorsque l’utilisateur saisit des données d’entrée incorrectes et que la validation intégrée échoue, un message s’affiche en haut du corps de la boîte de dialogue. Ce message s’affiche également lorsque la boîte de dialogue doit générer une erreur ou un message de confirmation lors de l’envoi du formulaire. Il est contrôlé avec le sélecteur de classe CSS suivant :
...
Exemple - Pour configurer un message afin d’utiliser une police en gras de dix points, utilisez une hauteur de ligne de 25 pixels et une marge intérieure de 20 pixels sur la gauche. Enfin, utilisez une icône de point d’exclamation, du texte rouge en cas d’erreur et aucune icône et du texte vert en cas de succès :
