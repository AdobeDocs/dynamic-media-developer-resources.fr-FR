...
description: La table des matières est un bouton de la barre de contrôle principale. Lorsqu’il est activé, un panneau déroulant s’affiche avec une liste d’index et de libellés de page.
