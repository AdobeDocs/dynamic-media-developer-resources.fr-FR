...
description: Le fait de sélectionner ce bouton effectue un zoom avant sur une image dans la vue principale. Ce bouton apparaît dans la barre de contrôle principale. Ce bouton n'est pas affiché sur les téléphones mobiles pour économiser l'espace de l'écran. Vous pouvez dimensionner, habiller et positionner ce bouton à l’aide de CSS.
