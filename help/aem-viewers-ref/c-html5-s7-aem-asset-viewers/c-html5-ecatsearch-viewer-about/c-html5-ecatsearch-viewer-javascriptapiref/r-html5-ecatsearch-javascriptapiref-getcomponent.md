...
<table id="table_7B5DD9303EF44ADD847B13FFEAD135D9"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> table des matières </span> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> des </span> de téléchargement </p> </td> 
   <td colname="col2"> <p> <span class="codeph"> s7sdk.common.Download </span> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> favorisEffect </span> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> favorisMenu </span> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> </span> <span class="codeph"> searchButton </p> </td> 
...
Consultez la documentation *API Viewer SDK* pour plus d’informations sur un composant particulier.
