...
feature: Dynamic Media Classic,Visionneuses,SDK/API,Recherche catalogue électronique,Accessibilité
role: Developer,User
...
L&#39;interface utilisateur de recherche est regroupée dans l&#39;élément avec le rôle `search`. Le champ de saisie de recherche a le rôle `searchbox` et référence le libellé informatif contrôlé par le symbole de localisation `SearchPanel.INFO_PROMPT` avec l’attribut `aria-describedby` .
