...
<table id="table_49FFD1BC53B846F09A6D214BC8C5C3FE"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> Réinitialise le port d'affichage lorsque l'image change. Si elle est définie sur <span class="varname"> 0</span>, elle conserve le port d’affichage actuel avec le meilleur ajustement possible tout en conservant les proportions de l’image nouvellement définie. </p> </td> 
  </tr> 
 </tbody> 
</table>
