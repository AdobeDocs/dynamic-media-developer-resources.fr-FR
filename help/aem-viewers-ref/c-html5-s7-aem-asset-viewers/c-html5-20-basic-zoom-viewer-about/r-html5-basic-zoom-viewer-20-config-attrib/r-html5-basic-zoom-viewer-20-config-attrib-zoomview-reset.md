...
<table id="table_49FFD1BC53B846F09A6D214BC8C5C3FE"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> Réinitialise le port d’affichage lorsque l’image (image) change. S’il est défini sur <span class="varname"> 0</span>, il conserve le port d’affichage actuel avec la meilleure approximation possible tout en conservant les proportions de l’image nouvellement définie. </p> </td> 
  </tr> 
 </tbody> 
</table>
