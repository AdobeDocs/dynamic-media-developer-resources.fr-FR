...
Exemple : pour configurer un bouton de zoom avant de 32 x 32 pixels et positionner six pixels à partir des bords supérieur et droit de la visionneuse. Il doit afficher une image différente pour chacun des quatre états de bouton différents.
