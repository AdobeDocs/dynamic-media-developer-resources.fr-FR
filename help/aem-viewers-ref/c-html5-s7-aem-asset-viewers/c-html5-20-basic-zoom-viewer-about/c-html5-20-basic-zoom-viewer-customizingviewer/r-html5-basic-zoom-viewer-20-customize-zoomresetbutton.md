...
description: Le fait de sélectionner ce bouton permet de réinitialiser une image dans la vue principale. Vous pouvez dimensionner, habiller et positionner ce bouton à l’aide de CSS.
...
Le fait de sélectionner ce bouton permet de réinitialiser une image dans la vue principale. Vous pouvez dimensionner, habiller et positionner ce bouton à l’aide de CSS.
...
Exemple : pour configurer un bouton de réinitialisation du zoom de 32 x 32 pixels positionné à six pixels du bord supérieur et droit de la visionneuse. Elle doit afficher une image différente pour chacun des quatre états de bouton différents.
