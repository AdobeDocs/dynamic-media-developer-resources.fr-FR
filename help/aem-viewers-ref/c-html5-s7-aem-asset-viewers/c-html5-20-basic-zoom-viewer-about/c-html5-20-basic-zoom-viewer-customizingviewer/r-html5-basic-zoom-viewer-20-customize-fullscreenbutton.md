...
Exemple : pour configurer un bouton plein écran de 32 x 32 pixels positionné à six pixels du bord supérieur et droit de la visionneuse. Lorsqu’il est sélectionné ou non, il doit afficher une image différente pour chacun des quatre états de bouton :
