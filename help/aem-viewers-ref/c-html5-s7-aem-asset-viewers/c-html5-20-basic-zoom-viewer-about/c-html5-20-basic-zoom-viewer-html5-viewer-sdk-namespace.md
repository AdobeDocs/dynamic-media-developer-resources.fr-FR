...
Si, par exemple, vous prévoyez d’écouter le  du `StatusEvent.NOTF_VIEW_READY` et que le lecteur est diffusé par AEM, le  de complet est `s7viewers.s7sdk.event.StatusEvent.NOTF_VIEW_READY`, et le code du module d’écoute de l’ d’audience de l’émission se présente comme suit :
