...
Lorsque vous utilisez des API SDK, il est important d’utiliser un espace de noms SDK correct et complet, comme décrit dans Espace de noms SDK de la visionneuse
