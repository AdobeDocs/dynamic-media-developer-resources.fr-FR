  ...
  <tr> 
   ...
   <td colname="col2"> <p>{ <span class="codeph"> JSON </span>} Objet JSON avec les champs facultatifs suivants (sensibles à la casse) : </p> <p> 
     <ul id="ul_26121393BC7145FF8A43C05ACCBEFF36"> 
      ...
      <li id="li_4659E82D38EB4438AAA04FDEAF21B087"> </span> de navigation <span class="codeph"> - URL ou chemin d’accès au contenu de navigation WebVTT. Le fichier WebVTT doit être diffusé par le service d’images </li> 
     </ul> </p> </td> 
  </tr> 
 </tbody> 
</table>
