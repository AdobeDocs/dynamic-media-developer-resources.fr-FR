...
Lorsque vous travaillez avec des API SDK, il est important d’utiliser le SDK complet  correctement qualifié, comme décrit dans le SDK du [lecteur de contenu,  le](../../../c-html5-s7-aem-asset-viewers/c-html5-video-reference/r-html5-video-viewer-20-namespace.md#concept-679bfabb3e3e4c12a285c4e9c4144153)de  de SDK.
