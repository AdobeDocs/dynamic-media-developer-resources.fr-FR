...
>[!NOTE]
>
>Le bouton Annuler prend en charge le sélecteur d’ `state` attributs, qui peut être utilisé pour appliquer différents habillages à différents états de bouton.
...
Les info-bulles des libellés de la boîte de dialogue peuvent être localisées. Pour plus d’informations, voir [des éléments](../../../c-html5-s7-aem-asset-viewers/c-html5-video-reference/r-html5-video-viewer-20-localization.md#concept-1d5ca2d8480f4064a51eddba13940aad) de l’interface utilisateur.
...
Exemple : pour définir les champs d’entrée de taille personnalisée avec une bordure, une marge et un remplissage gris d’un pixel et une largeur de 70 pixels :
