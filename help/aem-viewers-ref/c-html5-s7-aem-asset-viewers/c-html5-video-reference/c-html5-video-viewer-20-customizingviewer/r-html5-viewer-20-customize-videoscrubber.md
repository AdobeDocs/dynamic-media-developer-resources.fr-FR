...
description: La barre vidéo est la commande de curseur horizontal qui permet à un utilisateur de rechercher dynamiquement n’importe quelle position dans la vidéo en cours de lecture
...
L’info-bulle de la barre vidéo peut être localisée. Voir [Localisation des éléments de l’interface utilisateur](../../../c-html5-s7-aem-asset-viewers/c-html5-video-reference/r-html5-video-viewer-20-localization.md#concept-1d5ca2d8480f4064a51eddba13940aad) pour plus d’informations.

**Exemple** - Pour configurer une visionneuse de vidéos avec une barre vidéo dotée de couleurs de piste personnalisées. La barre de défilement doit avoir une hauteur de dix pixels et être positionnée à dix pixels et 35 pixels des bords supérieur et gauche de la barre de commande.
