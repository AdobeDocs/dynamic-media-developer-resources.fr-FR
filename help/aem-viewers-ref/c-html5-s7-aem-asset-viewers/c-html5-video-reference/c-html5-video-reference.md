---
description: La visionneuse vidéo est un lecteur vidéo qui lit la diffusion en flux continu et la vidéo progressive codée au format H.264. Il est diffusé à partir de Scene7 Publishing System ou d’AEM Dynamic Media.
keywords: responsive
seo-description: La visionneuse vidéo est un lecteur vidéo qui lit la diffusion en flux continu et la vidéo progressive codée au format H.264. Il est diffusé à partir de Scene7 Publishing System ou d’AEM Dynamic Media.
seo-title: Vidéo
...
La visionneuse vidéo est un lecteur vidéo qui lit la diffusion en flux continu et la vidéo progressive codée au format H.264. Il est diffusé à partir de Scene7 Publishing System ou d’AEM Dynamic Media.
...
La vidéo unique et les visionneuses de vidéos adaptatives sont prises en charge. De plus, le lecteur prend en charge l’utilisation de flux vidéo et HLS progressifs hébergés sur des emplacements externes. Il est conçu pour fonctionner sur les navigateurs Web mobiles et de bureau qui prennent en charge la vidéo HTML5. Cette visionneuse prend également en charge les sous-titres en option qui s’affichent au-dessus du contenu vidéo, de la navigation dans les chapitres vidéo et des outils de partage sur les réseaux sociaux.

La visionneuse vidéo utilise la lecture vidéo en flux continu HTML5 au format HLS dans sa configuration par défaut chaque fois que le système sous-jacent la prend en charge. Sur les systèmes qui ne prennent pas en charge la diffusion en flux continu HTML5, la visionneuse revient au vidéo progressif HTML5.
...
La visionneuse de vidéos représente un fichier JavaScript principal et un ensemble de fichiers d’aide : un seul fichier JavaScript est inclus avec tous les composants du SDK de la visionneuse utilisés par cette visionneuse, des ressources et des fichiers CSS téléchargés par la visionneuse au moment de l’exécution.

Vous pouvez utiliser la visionneuse vidéo en mode contextuel à l’aide de la page HTML prête à l’emploi fournie avec les visionneuses IS. Vous pouvez également utiliser le lecteur en mode intégré, où il est intégré dans une page Web de  à l’aide de l’API documentée.

Le de configuration et d’habillage de la visionneuse est similaire à celui des autres visionneuses. L’habillage est effectué au moyen d’une page CSS personnalisée.
...
## Interaction avec la visionneuse vidéo {#section-ab66eb6955aa4a8aa6d14a3b3acfed3f}

La visionneuse de vidéos fournit un ensemble de commandes standard de l’interface utilisateur pour la lecture vidéo, telles qu’un bouton de lecture/pause, une bulle de temps vidéo de la barre de défilement vidéo, un indicateur de temps de lecture/temps total, un contrôle du volume, un bouton plein écran et une bascule de sous-titrage. Tous ces contrôles sont regroupés dans une barre de contrôle au bas de l’interface utilisateur du lecteur de contenu.

Sur les périphériques tactiles, le contrôle du volume est masqué dans l’interface utilisateur, car il est possible de contrôler le volume uniquement à l’aide des boutons matériels.

Lorsque le lecteur fonctionne en mode contextuel, le bouton plein écran n’est pas disponible dans l’interface utilisateur.

Il est possible de naviguer rapidement dans le contenu d’une vidéo lorsque le chapitre vidéo est activé. Les chapitres vidéo sont affichés sous forme de marqueurs dans la piste de défilement vidéo et affichent le titre du chapitre et la description associée lors d’un survol de la souris ou d’un appui sur les systèmes tactiles. Les utilisateurs peuvent rechercher un chapitre particulier en cliquant sur un marqueur de chapitre ou en appuyant sur la bulle de description de chapitre.

Le lecteur prend en charge les entrées tactiles et de souris sur les périphériques Windows avec écran tactile et souris. Cette prise en charge est toutefois limitée aux navigateurs Web Chrome, Internet Explorer 11 et Edge.
...
La visionneuse de vidéos prend en charge les outils de partage sur les médias sociaux. Elle est disponible sous la forme d’un bouton unique dans l’interface utilisateur, qui s’étend dans une barre d’outils de partage lorsque l’utilisateur clique ou appuie dessus.

La barre d’outils de partage contient une icône pour chaque type de de partage pris en charge, tel que Facebook, Twitter, le partage de courrier électronique, le partage de code incorporé et le partage de liens. Lorsque des outils de partage de courrier électronique, de partage incorporé ou de partage de liens sont activés, le lecteur affiche une boîte de dialogue modale avec un formulaire de saisie de données correspondant. Lorsque Facebook ou Twitter sont appelés, le lecteur redirige l’utilisateur vers une boîte de dialogue de partage standard à partir d’un service de médias sociaux. En outre, lorsqu’un outil de partage est activé, la lecture vidéo est interrompue automatiquement.
...
Il est recommandé d’utiliser une page HTML prête à l’emploi pour le mode d’opération contextuel. Elle est appelée [!DNL VideoViewer.html] et se trouve sous le [!DNL html5/] sous-dossier du déploiement des visionneuses IS standard :
...
En mode intégré, le lecteur est ajouté à la page Web existante, qui peut déjà comporter du contenu client qui n’est pas lié au lecteur. En règle générale, le lecteur n’occupe qu’une partie de l’espace de la page Web.

Les principales utilisations sont les pages Web orientées vers les ordinateurs de bureau ou les tablettes, ainsi que les pages de conception réactives qui ajustent automatiquement la disposition en fonction du type de périphérique.

L’incorporation de taille fixe est utilisée lorsque la visionneuse ne modifie pas sa taille après le chargement initial. Ce choix est le meilleur pour les pages Web avec une disposition de page statique.

L’incorporation de la conception réactive suppose que le lecteur doit peut-être redimensionner au moment de l’exécution en réponse au changement de taille de sa  de `DIV`. Le cas d’utilisation le plus courant consiste à ajouter le lecteur à une page Web qui utilise une disposition de page souple.

En mode d’incorporation de conception réactive, le lecteur se comporte différemment selon la manière dont la page Web redimensionne son `DIV`. Si la page Web définit uniquement la largeur du  du `DIV`et que sa hauteur reste illimitée, le lecteur choisit automatiquement sa hauteur en fonction des proportions du fichier utilisé. Cette méthode permet de s’assurer que le fichier s’intègre parfaitement dans le  sans remplissage sur les côtés. Ce cas d’utilisation est le plus courant pour les pages Web qui utilisent une structure de mise en page adaptée telle que Bootstrap, Foundation, etc.
...
1. Ajout du fichier JavaScript de la visionneuse à votre page Web.
   ...
   Pour créer une visionneuse, vous devez ajouter une balise de script dans l’en-tête HTML. Avant d’utiliser l’API du lecteur de contenu, veillez à inclure [!DNL FlyoutViewer.js]. Le [!DNL FlyoutViewer.js] fichier se trouve sous le [!DNL html5/js/] sous-dossier du déploiement des visionneuses IS standard :
...
1. Définition de la  DIV du.
   ...
   Assurez-vous que la fonction plein écran fonctionne correctement dans Internet Explorer. Vérifiez qu’il n’existe aucun autre élément dans le modèle DOM dont l’ordre d’empilement est supérieur à celui de votre balise d’emplacement DIV.
...
1. Définition de la taille de la visionneuse
   ...
   Vous pouvez définir la taille statique de la visionneuse en la déclarant pour la classe CSS de `.s7videoviewer` niveau supérieur en unités absolues ou en utilisant le modificateur `stagesize`.
   ...
   Voir [Personnalisation de la visionneuse](../../c-html5-s7-aem-asset-viewers/c-html5-video-reference/c-html5-video-viewer-20-customizingviewer/c-html5-video-viewer-20-customizingviewer.md#concept-072a52b10b5f4c0789393dc6e2134c0e) vidéo pour plus d’informations sur le style de la visionneuse à l’aide de CSS.
   ...
   Vous pouvez définir `stagesize` le modificateur soit dans l’enregistrement des paramètres prédéfinis de la visionneuse dans Scene7 Publishing System, soit le transmettre explicitement avec le code d’initialisation de la visionneuse avec `params` la collection, soit sous la forme d’un appel d’API, comme décrit dans la section de référence Commande, comme dans l’exemple suivant :
...
1. Création et initialisation de la visionneuse.
   ...
   Voici un exemple de création d’une instance de visionneuse, de transmission des options de configuration minimales nécessaires au constructeur et d’appel de la `init()` méthode. Cet exemple suppose qu’il `videoViewer` s’agit de l’instance de visionneuse `s7viewer` du nom de l’espace réservé `DIV`, [!DNL http://s7d1.scene7.com/is/image/] de l’URL de diffusion d’images, [!DNL http://s7d1.scene7.com/is/content/] de l’URL du serveur vidéo et [!DNL Scene7SharedAssets/Glacier_Climber_MP4] du fichier.
...
L’ajout du lecteur à une telle page est très similaire à l’incorporation de taille fixe ; la seule différence est que vous n’avez pas besoin de définir explicitement la taille du lecteur.

1. Ajout du fichier JavaScript de la visionneuse à votre page Web.
1. Définition de la  DIV du.
1. Création et initialisation de la visionneuse.

Toutes les étapes ci-dessus sont identiques à celles de l’incorporation de taille fixe. Ajouter  `DIV` au &quot;titulaire&quot; existant `DIV`. Le code suivant est un exemple complet. Vous pouvez voir comment la taille de la visionneuse change lorsque le navigateur est redimensionné et comment les proportions de la visionneuse correspondent à la ressource.
...
La page d’exemples suivante illustre une utilisation plus réelle de la conception adaptée incorporée avec une hauteur libre :

[https://marketing.adobe.com/resources/help/en_US/s7/vlist/vlist.html](https://marketing.adobe.com/resources/help/en_US/s7/vlist/vlist.html)

**Conception réactive avec définition de la largeur et de la hauteur**

Dans le cas d’une conception adaptée incorporée avec une largeur et une hauteur définies, le style de la page Web est différent ; il fournit les deux tailles au &quot;détenteur&quot; `DIV` et le centre dans la fenêtre du navigateur. En outre, la page Web définit la taille de l’ `HTML` élément et `BODY` de l’élément sur 100 % :
...
Au lieu d’utiliser l’initialisation basée sur JSON, il est possible d’utiliser une API basée sur un setter et un constructeur sans args. Avec cette API, le constructeur ne prend aucun paramètre et les paramètres de configuration sont spécifiés à l’aide de méthodes `setContainerId()`, `setParam()`et `setAsset()` API avec des appels JavaScript distincts.
