...
Exemple : pour configurer des info-bulles dotées d’une bordure grise avec un rayon d’angle de 3 pixels, un arrière-plan noir et du texte blanc écrit avec Arial®, taille de 11 pixels :
