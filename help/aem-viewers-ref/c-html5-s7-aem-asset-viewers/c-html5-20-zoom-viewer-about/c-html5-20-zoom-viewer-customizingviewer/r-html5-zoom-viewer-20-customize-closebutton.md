---
title: Bouton Fermer
description: Lorsque vous sélectionnez ou appuyez sur ce bouton, la page Web contenant est fermée. Ce bouton ne s’affiche que si le paramètre close est défini sur 1. Vous pouvez dimensionner, habiller et positionner ce bouton à l’aide de CSS.
...
Lorsque vous sélectionnez ou appuyez sur ce bouton, la page Web contenant est fermée. Ce bouton ne s’affiche que si le paramètre close est défini sur 1. Vous pouvez dimensionner, habiller et positionner ce bouton à l’aide de CSS.
...
Exemple : pour configurer un bouton Fermer de 32 x 32 pixels et positionner six pixels à partir des bords supérieur et droit de la visionneuse. Et enfin, affiche une image différente pour chacun des quatre états de bouton différents.
