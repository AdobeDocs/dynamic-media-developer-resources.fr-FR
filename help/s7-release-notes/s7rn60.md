...
* Ajouté &quot;Code incorporé&quot; pour simplifier le déploiement des visionneuses.
   ...
   La [!DNL Embed Code] fonction est disponible lorsque vous ouvrez la [!DNL Preview: Viewer List] page ou le [!DNL URLs] panneau dans [!DNL Detail View] pour l’un des types de ressource suivants :
