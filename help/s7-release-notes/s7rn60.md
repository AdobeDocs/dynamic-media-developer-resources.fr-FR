...
* Ajout de la prise en charge de la localisation pour le texte d’info-bulle dans les paramètres prédéfinis de la visionneuse HTML5 et AS3 Flash.
...
* Nouveaux composants de visionneuse extensifs dans le SDK HTML5. (Voir le fichier Lisez-moi du SDK HTML 5 inclus dans le programme d’installation pour plus de détails.)
...
* Ajout de la prise en charge de la mondialisation pour les visionneuses, y compris la localisation de texte et de graphiques. Consultez les guides d’utilisation du SDK de la visionneuse HTML5 ou Flash inclus dans le programme d’installation du SDK.
...
* Compilez dynamiquement le contenu source des Flashs de bannières dynamiques (FLA) en films GIF animés, y compris la gestion avancée des images. <!-- [More information](http://help.adobe.com/en_US/scene7/using/WSd968ca97bf00cf72-5eedd3a113268dc80f4-8000.html).  -->
...
* Diffusion en continu iOS pour la vidéo générée par l’utilisateur. <!-- [More information](http://help.adobe.com/en_US/scene7/using/WSe8b0455615e2dc47-2df907a712f31201b35-8000.html). -->
