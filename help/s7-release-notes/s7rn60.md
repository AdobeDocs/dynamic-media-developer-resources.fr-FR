...
* Suite à cette version, une nouvelle fonctionnalité de publication instantanée est progressivement déployée. Cette fonctionnalité remplace la fonctionnalité actuelle &quot;Marquer pour publication&quot;. Certains utilisateurs peuvent voir la nouvelle fonctionnalité avant d’autres. La documentation SPS et les éléments de l’interface utilisateur sont prévus pour une mise à jour lorsque la période de déploiement approche de sa fin. Vous pouvez planifier la réception d’un email avec plus de détails au début du déploiement.
...
* Ajout du &quot;code incorporé&quot; pour simplifier le déploiement des visionneuses.
  ...
  La variable [!DNL Embed Code] Cette fonctionnalité est disponible lorsque vous ouvrez la [!DNL Preview: Viewer List] ou la variable [!DNL URLs] dans [!DNL Detail View] pour l’un des types de ressources suivants :
