...
Notes de mise à jour les plus récentes, décrivant les nouvelles fonctionnalités, les améliorations et les correctifs pour [!DNL Adobe Scene7 Publishing System] Version 6.8 de la solution Adobe Experience Manager dans [!DNL Adobe Experience Cloud].
...
* &quot;Space After&quot; ne fonctionne pas ; il doit utiliser `sa`, pour l’instant, `margb`.
...
* Corrigé : `selectSwatch` ne se déclenche pas lorsqu’elle est incorporée dans la méthode `initViewer()` de la fonction
...
* Corrigé : l’icône Partage sur les réseaux sociaux ne disparaît pas avec le `controlbar` sur Zoom.
