---
description: Notes de mise à jour les plus récentes, décrivant les nouvelles fonctionnalités, les améliorations et les correctifs pour Adobe Scene7 Publishing System 6.8, composant de la solution Adobe Experience Manager de l’Adobe Marketing Cloud.
seo-description: Notes de mise à jour les plus récentes, décrivant les nouvelles fonctionnalités, les améliorations et les correctifs pour Adobe Scene7 Publishing System 6.8, composant de la solution Adobe Experience Manager de l’Adobe Marketing Cloud.
...
Notes de mise à jour les plus récentes, décrivant les nouvelles fonctionnalités, les améliorations et les correctifs pour Adobe Scene7 Publishing System 6.8, composant de la solution Adobe Experience Manager de l’Adobe Marketing Cloud.

## Notes de mise à jour de Scene7 Publishing System 6.8 (mai 2014) {#topic-4517aab837ea4d6d8204425958860e5a}

Notes de mise à jour les plus récentes, décrivant les nouvelles fonctionnalités, les améliorations et les correctifs de la version [!DNL Adobe Scene7 Publishing System] 6.8 de la solution Adobe Experience Manager de la [!DNL Adobe Marketing Cloud]version.
...
* Adobe Analytics crée des rapports sur l’intégration des vidéos pour la visionneuse de vidéos HTML5 et la visionneuse de supports variés.
...
* La Société d’étiquettes ne s’affiche pas complètement dans la page de configuration de Analytics Adobe.
