...
* Supprimé **Création de SPSAdmin** fonction utilisateur de User Management en raison de problèmes de sécurité.
...
Pour obtenir une documentation complète, voir [Guide de référence des visionneuses](https://experienceleague.adobe.com/docs/dynamic-media-developer-resources/library/homeviewers.html).
...
* Vidéo HTML5
   ...
   * Les sous-titres vidéo nécessitent un jeu de règles de l’entreprise si l’hébergement de la page de HTML est diffusé à partir d’un serveur externe (et non d’un [!DNL Dynamic Media] ). Contactez l’assistance Adobe pour obtenir de l’aide.
