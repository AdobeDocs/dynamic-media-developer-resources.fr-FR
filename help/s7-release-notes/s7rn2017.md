...
Notes de mise à jour les plus récentes pour Adobe Dynamic Media Classic, composant de la [!DNL Adobe Experience Manager] solution dans le [!DNL Adobe Experience Cloud].
...
* Vidéo HTML5
   ...
   * Les légendes de vidéo nécessitent un jeu de règles de société si l’hébergement de la page HTML est diffusé à partir d’un serveur externe (et non d’un serveur Contenu multimédia dynamique). Contactez l’assistance Adobe pour obtenir de l’aide.
