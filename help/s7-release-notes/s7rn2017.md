---
description: Notes de mise à jour les plus récentes pour Adobe Classic, composant de la solution d’Adobe Experience Manager dans Adobe Experience Cloud.
seo-description: Notes de mise à jour les plus récentes pour Adobe Classic, composant de la solution d’Adobe Experience Manager dans Adobe Experience Cloud.
seo-title: Notes de mise à jour de Dynamic Media
...
Notes de mise à jour les plus récentes pour Adobe Classic, composant de la solution d’Adobe Experience Manager dans Adobe Experience Cloud.

## Notes de mise à jour de Dynamic Media {#topic-1f5af440670a42f3bbb662eb86a196c6}

Notes de mise à jour les plus récentes pour Adobe Classic, partie de la [!DNL Adobe Experience Manager] solution dans le [!DNL Adobe Experience Cloud].
