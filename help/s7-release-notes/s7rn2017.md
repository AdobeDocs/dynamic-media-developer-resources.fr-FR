...
Notes de mise à jour les plus récentes pour Adobe Dynamic Media Classic, qui fait partie de la section [!DNL Adobe Experience Manager] dans la [!DNL Adobe Experience Cloud].
...
* Vidéo HTML5
   ...
   * Les sous-titres vidéo nécessitent un jeu de règles de l’entreprise si l’hébergement de la page de HTML est diffusé à partir d’un serveur externe (et non d’un serveur Dynamic Media). Contactez l’assistance Adobe pour obtenir de l’aide.
