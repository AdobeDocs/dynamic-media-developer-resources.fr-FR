---
description: Notes de mise à jour les plus récentes, décrivant les nouvelles fonctionnalités, les améliorations et les correctifs pour Adobe Scene7 Publishing System 6.10, composant de la solution Adobe Experience Manager de l’Adobe Marketing Cloud.
seo-description: Notes de mise à jour les plus récentes, décrivant les nouvelles fonctionnalités, les améliorations et les correctifs pour Adobe Scene7 Publishing System 6.10, composant de la solution Adobe Experience Manager de l’Adobe Marketing Cloud.
...
Notes de mise à jour les plus récentes, décrivant les nouvelles fonctionnalités, les améliorations et les correctifs pour Adobe Scene7 Publishing System 6.10, composant de la solution Adobe Experience Manager de l’Adobe Marketing Cloud.

## Notes de mise à jour de Scene7 Publishing System 6.10 (mai 2015) {#topic-be8b44aea42643c496452726d4550226}

Notes de mise à jour les plus récentes qui décrivent les nouvelles fonctionnalités, les améliorations et les correctifs de la [!DNL Adobe Scene7 Publishing System] version 6.10 de la [!DNL Adobe Experience Manager] solution dans le [!DNL Adobe Marketing Cloud].
...
* **Type** de recherche - Possibilité d&#39;ajouter une propriété de société afin d&#39;autoriser la valeur par défaut du type de recherche personnel **[!UICONTROL Contient]**.
   ...
   Dans **[!UICONTROL Configuration]** > Groupe Configuration **** personnelle > En-tête **[!UICONTROL du navigateur]** > Type de recherche de **[!UICONTROL base liste déroulante - Contient.]******
...
<table id="table_69203DAA18F94A0F927BBA00634EBF65"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Recherche à partir du début de la chaîne et renvoie les résultats de la recherche plus rapidement que <span class="uicontrol"> Contient </span>. </p> <p>Il remplace la valeur par défaut définie dans <span class="uicontrol"> Configuration de l’application </span> &gt; <span class="uicontrol"> Groupe de paramètres généraux </span> &gt; <span class="uicontrol"> Autres paramètres, par Groupe d’applications &gt; Type de recherche de base par </span> <span class="uicontrol"> défaut pour les nouveaux utilisateurs  la liste déroulante Admin.</span> </p> </td> 
  </tr> 
 </tbody> 
</table>

Dans **[!UICONTROL Configuration]** de l’application > Groupe Paramètres **** généraux > **[!UICONTROL Autres paramètres, sélectionnez Groupe d’applications]** > Type de recherche **[!UICONTROL de base par défaut pour les nouveaux utilisateurs liste déroulante.]**
...
<table id="table_65BA9F98D1D041109A44B1C130EF4EFA"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>L’onglet comprend les paramètres relatifs à l’heure <span class="uicontrol"> d’expiration </span> et à la taille des miniatures <span class="uicontrol"> préférées </span> (). </p> <p> 
...
<table id="table_023203E3CC484F59A350C3C333EF817F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Permet de configurer le type d’animation de zoom à utiliser. Dans le rail de gauche, cliquez sur Fonctionnalités de la <span class="uicontrol"> visionneuse </span> pour accéder aux options de mode de <span class="uicontrol"> zoom suivantes </span> dans la liste déroulante : </p> <p> 
     <ul id="ul_8026EF465A044666A9DBCBFA43F74565"> 
      ...
      <li id="li_C78D3C94C36549B182E1118308BD7326"> <span class="uicontrol"> inline </span> - effectue un zoom lorsque la souris survole. </li> 
...
<table id="table_8B704CC077304CE2AC3E616D40B64CEF"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> liste délimitée par des virgules des expressions régulières pour qu’elles correspondent aux noms de fichier temporaires. La valeur par défaut est <span class="codeph"> .in..+ </span> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="codeph"> uploadserver.file.skip.remove.timeout </span> </td> 
   <td colname="col2"> <p> Durée, en secondes, d’attente depuis la dernière modification du fichier avant de supprimer un fichier temporaire dans une tâche de téléchargement de dossier. </p> <p>Une valeur de <span class="codeph"> &lt;= 0 </span> empêche la suppression des fichiers temporaires. Valeur par défaut : 3600. </p> </td> 
  </tr> 
  <tr> 
...
* Le fichier `<metadataArray>` était vide pour le [!DNL .vtt] fichier en réponse à l&#39;API `getAssets`.
...
* Condition de concurrence avec la restauration de dossiers entre le téléchargement de répertoires volumineux `deleteFolder` et serveur.
...
* La publication n’est pas utilisée `assetFile` de sorte que la publication intermédiaire ne fonctionne que pour les nouveaux fichiers.
...
Voir aussi Guide [de référence des](https://docs.adobe.com/content/help/en/dynamic-media-developer-resources/library/home.html)visionneuses.
...
* Prise en charge Ajoutée de l’écran plein écran natif IE11.
...
**Correction de bogues pour Scene7 OnDemand 5.0.3**
...
* Les paramètres de publication n’affichaient pas les profils de couleur de la société des ressources partagées de Scene7.
...
* Changement `@scene7.com` en `@adobe.com` dans l’adresse Envoyer le courrier électronique à partir de.
...
* Ajouté de nouveau le champ de valeur dans la recherche avancée. `Userdata`
* Une erreur s’est produite lorsque vous avez ajouté un champ défini par l’utilisateur ( **[!UICONTROL Configuration]** > **Métadonnées** > Champ **défini par l’** utilisateur) de type `Boolean`et une valeur de , puis que vous l’avez enregistré.`true`
...
* Scene7 Creative Suite Extensions est obsolète dans cette version en raison de la désactivation des panneaux Flash par l’application Creative Cloud. Le développement des workflows d’assimilation de contenu se concentre sur Adobe Experience Manager Dynamic Media et Creative Cloud. Pour Scene7, les fonctions de téléchargement et d’exportation dans Scene7 Publishing System sont conservées et peuvent être utilisées à la place.
* La vidéo UGC est obsolète dans cette version en raison d’une faible adoption. La configuration d’un autre compte SPS peut servir de solution de remplacement pour la vidéo UGC. Contactez l’assistance technique Adobe pour configurer un autre compte.
