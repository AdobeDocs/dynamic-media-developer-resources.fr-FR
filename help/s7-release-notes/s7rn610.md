...
<table id="table_8B704CC077304CE2AC3E616D40B64CEF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Durée, en secondes, à attendre depuis la dernière modification de fichier avant de supprimer un fichier temporaire dans une tâche de dossier de chargement. </p> <p>Une valeur de <span class="codeph"> &lt;= 0 </span> empêche la suppression des fichiers temporaires. La valeur par défaut est 3 600. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> autoset.dupcheck.</span> de sommeil.time </p> </td> 
   <td colname="col2"> <p>La valeur par défaut est 100. </p> </td>
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> autoset.dupretry.counter </span> </p> </td> 
   <td colname="col2"> <p>La valeur par défaut est 3. </p> </td>
  </tr> 
 </tbody> 
</table>
...
* Correction d’un problème en raison duquel s7sdk.browser.device.version détectait incorrectement la cinquième ™.
