...
* Surveillance de la fonction Invalider le cache CDN. Après avoir sélectionné votre modèle d’invalidation du réseau CDN (voir [Paramètres généraux](https://experienceleague.adobe.com/docs/dynamic-media-classic/using/setup/application-setup.html#general-settings)), et un **[!UICONTROL Invalider le réseau de diffusion de contenu]** est effectuée, un indicateur s’affiche maintenant avec une estimation du temps nécessaire pour effacer le cache.
...
* Visionneuse de supports variés HTML5 : La visionneuse s’est effondrée en mode réactif si la première ressource est en 2dspinset.
